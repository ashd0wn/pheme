...
abstract class CestAbstract
{
    ...
    protected string $login_username = 'pheme@pheme.com';
    protected string $login_password = 'PhemeFunctionalTests!';
    ...
    protected function uploadTestSong(): StationMedia
    {
        ...
        $songSrc = '/var/pheme/www/resources/error.mp3';
