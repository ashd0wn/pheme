<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Όλα τα ονόματα τομέα που αναφέρονται θα πρέπει να δείχνουν σε αυτή την εγκατάσταση Pheme. Διαχωρίστε πολλαπλά ονόματα τομέα με κόμματα.',
      ...
      'Customize Pheme Settings' => 'Προσαρμογή Ρυθμίσεων Pheme',
      ...
      'Donate to support Pheme!' => 'Δωρεά για υποστήριξη Pheme!',
      'Down' => 'Κάτω',
      'Download' => 'Λήψη',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Ενεργοποιήστε για να εκτελέσετε το Pheme αυτόματα νυχτερινά αντίγραφα ασφαλείας την καθορισμένη ώρα.',
      ...
      'Enter "Pheme" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Εισάγετε το "Pheme" ως όνομα της εφαρμογής. Μπορείτε να αφήσετε τα πεδία URL αμετάβλητα. Για "Scopes", απαιτούνται μόνο "write:media" και "write:statuses".',
      ...
      'Hide Pheme Branding on Public Pages' => 'Απόκρυψη Pheme Branding σε δημόσιες σελίδες',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Αν ένας επισκέπτης δεν είναι συνδεδεμένος και επισκέπτεται την αρχική σελίδα Pheme, μπορείτε να τον ανακατευθύνετε αυτόματα στη διεύθυνση URL που καθορίζεται εδώ. Αφήστε κενό για να τους ανακατευθύνετε στην οθόνη σύνδεσης από προεπιλογή.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Αν ενεργοποιηθεί, το Pheme θα καταγράφει αυτόματα τις ζωντανές εκπομπές που γίνονται σε αυτό το σταθμό ανά εκπομπή εγγραφών.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Αν ενεργοποιηθεί, το Pheme θα συνδεθεί με τη βάση δεδομένων MusicBrainz για να προσπαθήσει να βρει ένα ISRC για οποιαδήποτε αρχεία όπου λείπει. Η απενεργοποίηση αυτού μπορεί να βελτιώσει την απόδοση.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Αν επιλεχθεί, αυτό θα αφαιρέσει το εμπορικό σήμα Pheme από τις σελίδες με μέρος.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Μάθετε περισσότερα σχετικά με τα κανάλια κυκλοφορίας στο Pheme docs.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Σημείωση: Αυτή θα πρέπει να είναι η δημόσια σελίδα του ραδιοφωνικού σταθμού, όχι το Pheme URL. Θα συμπεριληφθεί σε λεπτομέρειες εκπομπής.',
      'Notes' => 'Σημειώσεις',
      'Notice' => 'Ειδοποίηση',
      'Now' => 'Τώρα',
      ...
      'Powered by Pheme' => 'Τροφοδοτείται από Pheme',
      ...
      'Settings' => 'Ρυθμίσεις',
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Οδηγίες εγκατάστασης για την εκπομπή λογισμικού είναι διαθέσιμα στο Pheme wiki.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'Το Shoutcast 2 DNAS δεν είναι ελεύθερο λογισμικό και η περιοριστική άδεια του δεν επιτρέπει στο Pheme να διανείμει το δυαδικό Shoutcast.',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'Εμφάνιση νέων κυκλοφοριών μέσα στο κανάλι ενημέρωσης στην αρχική σελίδα του Pheme.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'Το στερεοφωνικό εργαλείο δεν είναι ελεύθερο λογισμικό και η περιοριστική άδεια χρήσης του δεν επιτρέπει στο Pheme να διανείμει το δυαδικό στερεοφωνικό εργαλείο.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Pheme.' => 'Τα επεξεργάσιμα πλαίσια κειμένου είναι περιοχές όπου μπορείτε να εισάγετε προσαρμοσμένο κώδικα διαμόρφωσης. Τα μη επεξεργάσιμα τμήματα δημιουργούνται αυτόματα από το Pheme.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Αυτό είναι ένα προηγμένο χαρακτηριστικό και προσαρμοσμένος κώδικας δεν υποστηρίζεται επίσημα από Pheme. Μπορείτε να σπάσετε το σταθμό σας προσθέτοντας προσαρμοσμένο κώδικα, αλλά η αφαίρεση του θα πρέπει να διορθώσει τυχόν προβλήματα.',
      ...
      'This mode disables Pheme\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.' => 'Αυτή η λειτουργία απενεργοποιεί τη διαχείριση AutoDJ του Pheme, χρησιμοποιώντας το ίδιο το Liquidsoap για να διαχειριστείτε την αναπαραγωγή τραγουδιού. "Next Song" και κάποιες άλλες λειτουργίες δεν θα είναι διαθέσιμες.',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Αυτό το όνομα θα εμφανιστεί ως υποκεφαλίδα δίπλα στο λογότυπο Pheme για να βοηθήσει στην αναγνώριση αυτού του διακομιστή.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Αυτή η ουρά περιέχει τα εναπομείναντα κομμάτια με τη σειρά που θα τεθούν σε αναμονή από το Pheme AutoDJ (αν τα κομμάτια είναι επιλέξιμα για αναπαραγωγή).',
      ...
      'Update' => 'Ενημέρωση',
      'Update Pheme' => 'Ενημέρωση Pheme',
      'Update Pheme via Web' => 'Ενημέρωση του Pheme μέσω Web',
      'Update Pheme? Your installation will restart.' => 'Ενημέρωση Pheme? Η εγκατάστασή σας θα κάνει επανεκκίνηση.',
      ...
      'Use' => 'Χρήση',
      'Use (Us)' => 'Χρήση (Us)',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Χρησιμοποιήστε τα κλειδιά API για τον έλεγχο ταυτότητας με το Pheme API χρησιμοποιώντας τα ίδια δικαιώματα με τον λογαριασμό χρήστη σας.',
      ...
      'Wednesday' => 'Τετάρτη',
      'Weight' => 'Βάρος',
      'Welcome to Pheme!' => 'Καλώς ήλθατε στο Pheme!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Μπορείτε να ορίσετε μια προσαρμοσμένη διεύθυνση URL για αυτήν τη ροή που θα χρησιμοποιήσει το Pheme όταν αναφέρεται σε αυτήν. Αφήστε κενό για να χρησιμοποιήσετε την προεπιλεγμένη τιμή.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Αυτό είναι ένα δοκιμαστικό μήνυμα από το Pheme. Αν λαμβάνετε αυτό το μήνυμα, σημαίνει ότι οι ρυθμίσεις του e-mail σας έχουν ρυθμιστεί σωστά.',
      'Test message sent successfully.' => 'Δοκιμαστικό μήνυμα εστάλη επιτυχώς.',
      'Pheme Application Log' => 'Αρχείο Καταγραφής Εφαρμογών Pheme',
      'Pheme Now Playing Log' => 'Pheme Τώρα Παίζοντας Καταγραφή',
      'Pheme Synchronized Task Log' => 'Pheme Συγχρονισμένο Αρχείο Καταγραφής Εργασιών',
      'Pheme Queue Worker Log' => 'Pheme Καταγραφή Εργαζομένων Ουράς',
      ...
      'New Pheme Stable Release Available' => 'Διαθέσιμη Νέα Pheme Σταθερή Κυκλοφορία',
      ...
      'New Pheme Rolling Release Available' => 'Διαθέσιμη Νέα Pheme Σταθερή Κυκλοφορία',
      ...
      'Pheme is free and open-source software.' => 'Το Pheme είναι ελεύθερο και ανοικτού κώδικα λογισμικό.',
      'If you are enjoying Pheme, please consider donating to support our work. We depend on donations to build new features, fix bugs, and keep Pheme modern, accessible and free.' => 'Εάν απολαμβάνετε Pheme, παρακαλούμε σκεφτείτε να δωρίσετε για να υποστηρίξετε το έργο μας. Εξαρτόμαστε από τις δωρεές για να οικοδομήσουμε νέα χαρακτηριστικά, διορθώνουμε σφάλματα, και να κρατήσει Pheme σύγχρονο, προσβάσιμο και δωρεάν.',
      'Donate to Pheme' => 'Δωρεά στο Pheme',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Μπορείτε να παρακολουθείτε τον χρόνο εκτέλεσης και τη χρήση μνήμης οποιασδήποτε σελίδας Pheme ή εφαρμογής από τη σελίδα προφίλ.',
      ...
      'This likely means that multiple Pheme instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.' => 'Αυτό πιθανόν σημαίνει ότι πολλές περιπτώσεις Pheme συνδέονται με την ίδια βάση δεδομένων. Αυτή η παρουσία δεν είναι η τρέχουσα ενεργή, οπότε οι συγχρονισμένες εργασίες δεν θα εκτελούνται σε αυτόν τον διακομιστή. Αν αυτό είναι σκόπιμο, μπορείτε να αγνοήσετε αυτό το μήνυμα.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Αν χρησιμοποιείτε τακτικά διαφορετικές διευθύνσεις URL για να αποκτήσετε πρόσβαση στο Pheme, θα πρέπει να ενεργοποιήσετε τη ρύθμιση "Prefer Browser URL".',
      ...
      'Pheme Settings' => 'Ρυθμίσεις Pheme',
      ...
      'Pheme Backup' => 'Αντίγραφο Ασφαλείας Pheme',
      ...
      'Pheme Initializing...' => 'Pheme Αρχικοποίηση...',
      'Pheme Setup' => 'Ρυθμίσεις Pheme',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Καλώς ήρθατε στο Pheme. Παρακαλώ περιμένετε ενώ κάποιες βασικές εξαρτήσεις του Pheme έχουν ρυθμιστεί...',
      ...
      'Pheme is now updated to the latest version!' => 'Το Pheme ενημερώνεται τώρα στην τελευταία έκδοση!',
      'Pheme installation complete!' => 'Η εγκατάσταση του Pheme ολοκληρώθηκε!',
      ...
      'Pheme Installer' => 'Εγκατάσταση Pheme',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Καλώς ήρθατε στο Pheme! Ολοκληρώστε την αρχική εγκατάσταση του διακομιστή απαντώντας σε μερικές ερωτήσεις.',
      'Pheme Updater' => 'Pheme Updater',
      'Change installation settings?' => 'Αλλαγή ρυθμίσεων εγκατάστασης;',
      'Pheme is currently configured to listen on the following ports:' => 'Το Pheme έχει ρυθμιστεί να ακούει στις ακόλουθες θύρες:',
      'HTTP Port: %d' => 'Θύρα HTTP: %d',
      'HTTPS Port: %d' => 'Θύρα HTTPS: %d',
      'SFTP Port: %d' => 'Θύρα SFTP: %d',
      'Radio Ports: %s' => 'Ραδιοθυρίδες: %s',
      'Customize ports used for Pheme?' => 'Προσαρμόστε τις θύρες που χρησιμοποιούνται για το Pheme;',
      ...
      'This file was automatically generated by Pheme.' => 'Αυτό το αρχείο δημιουργήθηκε αυτόματα από το Pheme.',
      ...
      'HTTP Port' => 'Θύρα HTTP',
      'The main port Pheme listens to for insecure HTTP connections.' => 'Η κύρια θύρα Pheme ακούει για μη ασφαλείς συνδέσεις HTTP.',
      'HTTPS Port' => 'Θύρα HTTPS',
      'The main port Pheme listens to for secure HTTPS connections.' => 'Η κύρια θύρα Pheme ακούει για ασφαλείς συνδέσεις HTTPS.',
      'The port Pheme listens to for SFTP file management connections.' => 'Το λιμάνι Pheme ακούει για συνδέσεις διαχείρισης αρχείων SFTP.',
      'Station Ports' => 'Λιμένες Σταθμού',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'Τα λιμάνια Pheme θα πρέπει να ακούσετε για ραδιοτηλεοπτικές εκπομπές σταθμού και εισερχόμενες συνδέσεις DJ.',
