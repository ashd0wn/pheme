<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Alla listade domännamn bör peka på denna Pheme-installation. Separera flera domännamn med kommatecken.',
      ...
      'Pheme First-Time Setup' => 'Pheme första gången installation',
      'Pheme Instance Name' => 'Pheme-instans namn',
      'Pheme ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'Pheme skickas med en inbyggd gratis IP-geolocation databas. Du kanske föredrar att använda MaxMind GeoLite-tjänsten istället för att uppnå mer exakta resultat. Använda MaxMind GeoLite kräver en licensnyckel, men när nyckeln är tillhandahållen, kommer vi automatiskt att hålla databasen uppdaterad.',
      'Pheme Update Checks' => 'Pheme Uppdateringskontroller',
      'Pheme User' => 'Pheme-användare',
      'Pheme uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Pheme använder ett rollbaserat tillgång kontrollsystem. Roller ges behörighet till vissa delar av webbplatsen, sedan användare tilldelas dessa roller.',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme kommer att skanna den uppladdade filen för matcher i den här stationens musikbibliotek. Media bör redan ha laddats upp innan du kör detta steg. Du kan använda denna tjänst hur många gånger du vill.',
      'Back' => 'Tillbaka',
      ...
      'Customize Pheme Settings' => 'Anpassa Pheme-inställningar',
      ...
      'Donate to support Pheme!' => 'Donera för att stödja Pheme!',
      'Down' => 'Ner',
      'Download' => 'Hämta',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Aktivera för att få Pheme att automatiskt köra nattliga säkerhetskopior vid angiven tidpunkt.',
      ...
      'Enter "Pheme" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Ange "Pheme" som programnamnet. Du kan lämna URL-fälten oförändrade. För "Scopes", endast "write:media" och "write:statuses" krävs.',
      ...
      'Hide Pheme Branding on Public Pages' => 'Dölj Pheme Branding på offentliga sidor',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Om en besökare inte är inloggad och besöker Phemes hemsida, kan du automatiskt omdirigera dem till den URL som anges här. Lämna tomt för att omdirigera dem till inloggningsskärmen som standard.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Om aktiverad, kommer Pheme automatiskt spela in alla livesändningar som görs till denna station till inspelningar per sändning.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Om aktiverad, kommer Pheme att ansluta till MusicBrainz databas för att försöka hitta en ISRC för alla filer där man saknas. Inaktivera detta kan förbättra prestandan.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Om vald, kommer detta att ta bort Pheme branding från offentliga sidor.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Läs mer om utgivningskanaler i Pheme-dokumenten.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Obs: Detta bör vara radiostationens publika hemsida, inte Pheme URL. Den kommer att inkluderas i sändningsdetaljer.',
      'Now' => 'Nu',
      ...
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Installationsinstruktioner för sändningsprogram finns tillgängliga på Pheme wiki.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS är inte fri programvara och dess restriktiva licens tillåter inte Pheme att distribuera Shoutcast-binären.',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'Visa nya utgåvor i din uppdateringskanal på Phemes hemsida.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'Stereo Tool är inte fri programvara, och dess restriktiva licens tillåter inte Pheme att distribuera Stereo Tool binära.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Pheme.' => 'De redigerbara textrutorna är områden där du kan infoga anpassad konfigurationskod. De icke-redigerbara avsnitten genereras automatiskt av Pheme.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Detta är en avancerad funktion och anpassad kod stöds inte officiellt av Pheme. Du kan bryta din station genom att lägga till anpassad kod, men ta bort den bör åtgärda eventuella problem.',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Detta namn kommer att visas som en underrubrik bredvid Pheme-logotypen, för att hjälpa till att identifiera denna server.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Denna kö innehåller de återstående spåren i den ordning de kommer att köas av Pheme AutoDJ (om spåren är berättigade att spelas).',
      ...
      'Update' => 'Uppdatera',
      'Update Pheme' => 'Uppdatera Pheme',
      'Update Pheme via Web' => 'Uppdatera Pheme via webben',
      ...
      'Use' => 'Använd',
      'Use (Us)' => 'Använd (U)',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Använd API-nycklar för att autentisera med Pheme API med samma behörigheter som ditt användarkonto.',
      ...
      'Website' => 'Webbplats',
      'Wednesday' => 'Onsdag',
      'Welcome to Pheme!' => 'Välkommen till Pheme!',
      'Welcome!' => 'Välkommen!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Du kan ställa in en anpassad URL för denna ström som Pheme kommer att använda när du refererar till den. Lämna tomt för att använda standardvärdet.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Detta är ett testmeddelande från Pheme. Om du får detta meddelande, betyder det att dina e-postinställningar är konfigurerade korrekt.',
      'Test message sent successfully.' => 'Testmeddelandet har skickats.',
      'Pheme Application Log' => 'Pheme-applikationslogg',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Du kan spåra exekveringstiden och minnesanvändningen av någon Pheme-sida eller program från profilersidan.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Om du regelbundet använder olika webbadresser för att komma åt Pheme, bör du aktivera inställningen "Föredrar Webbläsarens URL".',
      ...
      'Pheme Initializing...' => 'Pheme initierar...',
      'Pheme Setup' => 'Pheme Konfiguration',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Välkommen till Pheme. Vänta medan några nyckelberoenden för Pheme är inställda...',
      'Running Database Migrations' => 'Kör databasmigreringar',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme är nu uppdaterad till den senaste versionen!',
      'Pheme installation complete!' => 'Pheme-installationen är klar!',
      ...
      'Pheme Installer' => 'Pheme Installerare',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Välkommen till Pheme! Slutför den ursprungliga serverkonfigurationen genom att svara på några frågor.',
      'Pheme Updater' => 'Pheme-uppdaterare',
      'Change installation settings?' => 'Ändra installationsinställningar?',
      'Pheme is currently configured to listen on the following ports:' => 'Pheme är för närvarande konfigurerad att lyssna på följande portar:',
      'HTTP Port: %d' => 'HTTP-port: %d',
      'HTTPS Port: %d' => 'HTTPS-port: %d',
      'SFTP Port: %d' => 'SFTP-port: %d',
      'Radio Ports: %s' => 'Radions portar: %s',
      'Customize ports used for Pheme?' => 'Anpassa portar som används för Pheme?',
      'Writing configuration files...' => 'Skriver konfigurationsfiler...',
      'Server configuration complete!' => 'Serverkonfigurationen slutförd!',
      'This file was automatically generated by Pheme.' => 'Denna fil genererades automatiskt av Pheme.',
      ...
      'HTTP Port' => 'HTTP-port',
      'The main port Pheme listens to for insecure HTTP connections.' => 'Den huvudsakliga porten Pheme lyssnar på för osäkra HTTP-anslutningar.',
      'HTTPS Port' => 'HTTPS-port',
      'The main port Pheme listens to for secure HTTPS connections.' => 'Den huvudsakliga hamnen Pheme lyssnar på för säkra HTTPS-anslutningar.',
      'The port Pheme listens to for SFTP file management connections.' => 'Porten Pheme lyssnar på för SFTP-filhanteringsanslutningar.',
      'Station Ports' => 'Station Portar',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'Portarna Pheme bör lyssna på för stationssändningar och inkommande DJ-anslutningar.',
