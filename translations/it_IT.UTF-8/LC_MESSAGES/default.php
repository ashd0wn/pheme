<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Tutti i nomi di dominio elencati dovrebbero puntare a questa installazione di Pheme. Separare più nomi di dominio con virgole.',
      ...
      'Pheme First-Time Setup' => 'Prima impostazione Pheme',
      'Pheme Instance Name' => 'Nome istanza Pheme',
      'Pheme Update Checks' => 'Controllo Aggiornamenti di Pheme',
      'Pheme User' => 'Utente Pheme',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme scansionerà il file caricato alla ricerca di corrispondenze nella libreria musicale di questa stazione. I media dovrebbero già essere caricati prima di eseguire questo passaggio. È possibile rieseguire questo strumento quante volte è necessario.',
      'Back' => 'Indietro',
      ...
      'Customize Pheme Settings' => 'Personalizza impostazioni Pheme',
      ...
      'Donate to support Pheme!' => 'Dona per supportare Pheme!',
      'Down' => 'Giù',
      'Download' => 'Scarica',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Consente ad Pheme di eseguire automaticamente i backup notturni all\'ora specificata.',
      ...
      'Hide Pheme Branding on Public Pages' => 'Nascondi il marchio Pheme nelle pagine pubbliche',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Se un utente non ha effettuato l\'accesso e visita la home page di Pheme, è possibile reindirizzarlo automaticamente all\'URL specificato qui. Lascia vuoto per reindirizzare per default alla schermata di accesso.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Se selezionato, rimuoverà il marchio Pheme dalle pagine rivolte al pubblico.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Nota: questa dovrebbe essere la home page pubblica della stazione radio, non l\'URL Pheme. Sarà inclusa nei dettagli della web radio.',
      'Now' => 'Adesso',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Questo nome apparirà come sottotitolo accanto al logo Pheme, per aiutare a identificare questo server.',
      ...
      'Website' => 'Sito Web',
      'Wednesday' => 'Mercoledì',
      'Welcome to Pheme!' => 'Benvenuto in Pheme!',
      'Welcome!' => 'Benvenuto!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'È possibile impostare un URL personalizzato per questo flusso che Pheme utilizzerà quando farà riferimento ad esso. Lascia vuoto per utilizzare il valore predefinito.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Questo è un messaggio di prova da parte di Pheme. Se stai ricevendo questo messaggio, significa che le tue impostazioni email sono configurate correttamente.
',
      'Pheme Application Log' => 'Log dell\'applicazione Pheme',
      ...
      'Pheme Settings' => 'Impostazioni Pheme',
      ...
      'Pheme Initializing...' => 'Inizializzazione Pheme...',
      'Pheme Setup' => 'Configurazione Pheme',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Benvenuto in Pheme. Attendi mentre vengono impostate alcune dipendenze chiave di Pheme...',
      'Running Database Migrations' => 'Migrazioni del database in esecuzione',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme è ora aggiornato all\'ultima versione!',
      'Pheme installation complete!' => 'Installazione Pheme completata!',
      ...
      'Pheme is currently configured to listen on the following ports:' => 'Pheme è attualmente configurato per ascoltare le seguenti porte:',
