<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Todos los nombres de dominio listados deben apuntar a esta instalación de Pheme. Separa varios nombres de dominio con comas.',
      ...
      'Connected AzuraRelays' => 'Relés de Pheme Conectados',
      ...
      'Customize Pheme Settings' => 'Personalizar Ajustes de Pheme',
      ...
      'Donate to support Pheme!' => '¡Dona para apoyar a Pheme!',
      'Down' => 'Bajar',
      'Download' => 'Descargar',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Activar para que Pheme ejecute automáticamente copias de seguridad nocturnas en el momento especificado.',
      ...
      'Enter "Pheme" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Introduzca "Pheme" como nombre de la aplicación. Puede dejar los campos de URL sin cambios. Para "Ámbitos", solo se requieren "escribir: medios" y "escribir: estados".',
      ...
      'Hide Pheme Branding on Public Pages' => 'Ocultar la Marca Pheme en Páginas Públicas',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Si un visitante no ha iniciado sesión y visita la página de inicio de Pheme, puede redirigirlo automáticamente a la URL especificada aquí. Déjelo en blanco para redirigirlos a la pantalla de inicio de sesión de forma predeterminada.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Si está activado, Pheme grabará automáticamente cualquier transmisión en directo realizada en esta emisora para grabaciones por emisión en directo.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Si está habilitado, Pheme se conectará a la base de datos de MusicBrainz para intentar encontrar un ISRC para cualquier archivo donde falte uno. Deshabilitar esto puede mejorar el rendimiento.',
      ...
      'If enabled, streamers (or DJs) will be able to connect directly to your stream and broadcast live music that interrupts the AutoDJ stream.' => 'Si está activado, los streamers (o DJs) podrán conectarse directamente a su stream y transmitir música en vivo que interrumpirá el flujo de AutoDJ de Pheme.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Si se selecciona, se eliminará la marca Pheme de las páginas públicas.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Obtenga más información sobre los canales de liberación en la documentación de Pheme.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Nota: Esta debe ser la página de inicio pública de la estación de radio, no la URL de Pheme. Se incluirá en los detalles de la transmisión.',
      'Notes' => 'Notas',
      'Notice' => 'Aviso',
      'Now' => 'Ahora',
      ...
      'Powered by Pheme' => 'Desarrollado por Pheme',
      ...
      'Settings' => 'Ajustes',
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Las instrucciones de configuración para el software de transmisión están disponibles en la wiki de Pheme.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'El DNAS de Shoutcast 2 no es software gratuito y su licencia restrictiva no permite que Pheme distribuya el binario de Shoutcast.',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'Mostrar nuevas versiones dentro de su canal de actualizaciones en la página de inicio de Pheme.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'Stereo Tool no es software gratuito y su licencia restrictiva no permite que Pheme distribuya el binario Stereo Tool.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Esta es una característica avanzada y el código personalizado no está soportado oficialmente por Pheme. Puede romper su estación añadiendo código personalizado, pero eliminarlo debería arreglar cualquier problema.',
      ...
      'This mode disables Pheme\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.' => 'Este modo desactiva la gestión AutoDJ de Pheme, utilizando el propio Liquidsoap para gestionar la reproducción de canciones. "Siguiente Tema" y algunas otras funciones no estarán disponibles.',
      'This Month' => 'Este Mes',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Este nombre aparecerá como un sub encabezado junto al logotipo de Pheme, para ayudar a identificar este servidor.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Esta cola contiene las pistas restantes en el orden en que Pheme AutoDJ las pondrá en cola (si las pistas son elegibles para reproducirse).',
      ...
      'Update' => 'Actualizar',
      'Update Pheme' => 'Actualizar Pheme',
      'Update Pheme via Web' => 'Actualizar Pheme vía Web',
      'Update Pheme? Your installation will restart.' => '¿Actualizar Pheme? Su instalación se reiniciará.',
      ...
      'Use' => 'Uso',
      'Use (Us)' => 'Uso (Us)',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Utilice las claves API para autenticarse con la API de Pheme usando los mismos permisos que su cuenta de usuario.',
      ...
      'Website' => 'Sitio Web',
      'Wednesday' => 'Miércoles',
      'Welcome to Pheme!' => '¡Bienvenido a Pheme!',
      'Welcome!' => 'Bienvenido!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Puede establecer una URL personalizada para este stream y que Pheme utilizará al referirse a ella. Dejar en blanco para usar los valor por defecto.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Este es un mensaje de prueba de Pheme. Si está recibiendo este mensaje, significa que su configuración de correo electrónico está configurada correctamente.',
      'Test message sent successfully.' => 'Mensaje de prueba enviado con éxito.',
      'Pheme Application Log' => 'Log de aplicación de Pheme',
      'Pheme Now Playing Log' => 'Registro de Reproducción en Curso de Pheme',
      'Pheme Synchronized Task Log' => 'Registro de Tarea Sincronizada de Pheme',
      'Pheme Queue Worker Log' => 'Registro de Trabajadores de Cola de Pheme',
      ...
      'New Pheme Stable Release Available' => 'Disponible Nueva Versión Estable de Pheme',
      ...
      'New Pheme Rolling Release Available' => 'Disponible Nueva Versión de Pheme',
      ...
      'Your Rolling Release installation is currently older than the latest Stable release. This means you can switch releases to the "Stable" release channel if desired.' => 'Su versión "Rolling" de Pheme es más antigua que la versión "Estable" más reciente. Esto significa que puede cambiar su instalación a la versión "Estable" si así lo desea.',
      ...
      'Pheme is free and open-source software.' => 'Pheme es un software gratuito y de código abierto.',
      'If you are enjoying Pheme, please consider donating to support our work. We depend on donations to build new features, fix bugs, and keep Pheme modern, accessible and free.' => 'Si está disfrutando de Pheme, por favor considere donar para apoyar nuestro trabajo. Dependemos de donaciones para construir nuevas características, corregir errores y mantener Pheme moderno, accesible y gratuito.',
      'Donate to Pheme' => 'Donar a Pheme',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Puede rastrear el tiempo de ejecución y el uso de la memoria de cualquier página o aplicación de Pheme desde la página del generador de perfiles.',
      ...
      'This likely means that multiple Pheme instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.' => 'Esto probablemente significa que múltiples instancias de Pheme se están conectando a la misma base de datos. Esta instancia no es la activa actualmente, por lo que las tareas sincronizadas no se ejecutarán en este servidor. Si esto es intencional, puede ignorar este mensaje.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Si utiliza regularmente diferentes URL´s para acceder a Pheme, debe habilitar la configuración "Preferir URL del navegador".',
      ...
      'Pheme Settings' => 'Configuración de Pheme',
      ...
      'Pheme Backup' => 'Copia de seguridad de Pheme',
      ...
      'Pheme Initializing...' => 'Inicializando Pheme...',
      'Pheme Setup' => 'Configurar Pheme',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Bienvenido a Pheme. Por favor, espere mientras se configuran algunas dependencias clave de Pheme...',
      'Running Database Migrations' => 'Ejecutando Migraciones de Base de Datos',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme ha sido actualizado a la versión mas reciente!',
      'Pheme installation complete!' => '¡Instalación completa de Pheme!',
      ...
      'Pheme Installer' => 'Instalador de Pheme',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => '¡Bienvenido a Pheme! Complete la configuración inicial del servidor respondiendo a algunas preguntas.',
      'Pheme Updater' => 'Actualizador Pheme',
      'Change installation settings?' => '¿Cambiar configuraciones de la instalación?',
      'Pheme is currently configured to listen on the following ports:' => 'Pheme está configurado para escuchar en los siguientes puertos:',
      'HTTP Port: %d' => 'Puerto HTTP: %d',
      'HTTPS Port: %d' => 'Puerto HTTPS: %d',
      'SFTP Port: %d' => 'Puerto SFTP: %d',
      'Radio Ports: %s' => 'Puertos de Radio: %s',
      'Customize ports used for Pheme?' => '¿Personalizar los puertos utilizados para Pheme?',
      ...
      'This file was automatically generated by Pheme.' => 'Este archivo fue generado automáticamente por Pheme.',
      ...
      'The main port Pheme listens to for insecure HTTP connections.' => 'El puerto principal que Pheme escucha en busca de conexiones HTTP inseguras.',
      'HTTPS Port' => 'Puerto HTTPS',
      'The main port Pheme listens to for secure HTTPS connections.' => 'El puerto principal que Pheme escucha en busca de conexiones HTTPS seguras.',
      'The port Pheme listens to for SFTP file management connections.' => 'El puerto que Pheme escucha para las conexiones de administración de archivos SFTP.',
      'Station Ports' => 'Puertos de la Estación',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'Los puertos que Pheme debe escuchar para las emisiones de la estación y las conexiones entrantes de DJ.',
