<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'เปิดใช้งานเพื่อเรียกใช้การสำรองข้อมูลทุกคืนโดยอัตโนมัติตามเวลาที่กำหนด',
      ...
      'Hide Pheme Branding on Public Pages' => 'ซ่อนการสร้างแบรนด์ Pheme บนหน้าสาธารณะ',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'หากผู้เยี่ยมชมไม่ได้ลงชื่อเข้าใช้และเข้าไปที่หน้าแรก, คุณสามารถเปลี่ยนเส้นทางไปยัง URL ที่ระบุไว้ที่นี่โดยอัตโนมัติ. เว้นว่างไว้เพื่อเปลี่ยนเส้นทางไปยังหน้าจอเข้าสู่ระบบตามค่าเริ่มต้น',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'หากเลือกการดำเนินการนี้จะลบการสร้างแบรนด์ Pheme จากหน้าที่เปิดเผยต่อสาธารณะ',
      ...
      'None' => 'ไม่มี',
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'หมายเหตุ: นี่ควรเป็นหน้าแรกของสถานีวิทยุที่เปิดเผยต่อสาธารณะไม่ใช่ URL ของ Pheme จะรวมอยู่ในรายละเอียดการออกอากาศ',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'แสดงเวอร์ชั่นใหม่ที่อยู่ในช่องการอัปเดตของคุณบนหน้าแรกของ Pheme',
      ...
      'Wednesday' => 'พุธ',
      'Yes' => 'はい',
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'คุณสามารถตั้งค่า URL ที่กำหนดเองสำหรับสตรีมนี้ที่ Pheme จะใช้เมื่ออ้างถึง เว้นว่างไว้เพื่อใช้ค่าเริ่มต้น',
      ...
      'Pheme Application Log' => 'บันทึกแอปพลิเคชัน Pheme',
      ...
      'Pheme Setup' => 'ตั้งค่า Pheme',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'ยินดีต้อนรับสู่ Pheme โปรดรอสักครู่ในขณะที่การอ้างอิงคีย์ของ Pheme ถูกตั้งค่า...',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme ได้รับการอัปเดตเป็นเวอร์ชันล่าสุดแล้ว!',
      'Pheme installation complete!' => 'การติดตั้ง Pheme เสร็จสมบูรณ์!',
