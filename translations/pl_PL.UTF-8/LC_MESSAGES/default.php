<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Wszystkie wymienione nazwy domen powinny wskazywać na tę instalację Pheme. Jesli używasz kilku nazw domen, oddziel je przecinkami.',
      ...
      'Pheme First-Time Setup' => 'Ustawienia podczas pierwszego uruchomienia Pheme',
      'Pheme Instance Name' => 'Nazwa instancji Pheme',
      'Pheme ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'Pheme posiada wbudowaną darmową bazę geolokalizacji IP. Zamiast tego możesz korzystać z usługi MaxMind GeoLite aby uzyskać dokładniejsze wyniki. Korzystanie z MaxMind GeoLite wymaga klucza licencyjnego, ale gdy klucz zostanie dostarczony, będziemy automatycznie aktualizować bazę danych.',
      'Pheme Update Checks' => 'Sprawdzanie aktualizacji Pheme',
      'Pheme User' => 'Użytkownik Pheme',
      'Pheme uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Pheme używa systemu kontroli dostępu opartego na rolach. Zezwolenia dostępu do niektórych sekcji witryny są przypisywane rolom, a następnie użytkownicy są przypisani do tych ról.',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme zeskanuje przesłany plik w poszukiwaniu meczy w bibliotece muzycznej tej stacji. Media powinny być już przesłane przed uruchomieniem tego kroku. Możesz ponownie uruchomić to narzędzie tyle razy, ile potrzebuje.',
      'Back' => 'Wstecz',
      ...
      'Customize Pheme Settings' => 'Dostosuj ustawienia Pheme',
      ...
      'Donate to support Pheme!' => 'Wspomóż Pheme wpłatą!',
      'Down' => 'W dół',
      'Download' => 'Pobierz',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Pozwala Pheme na automatyczne tworzenie nocnych kopii zapasowych w podanym czasie.',
      ...
      'Enter "Pheme" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Wpisz "Pheme" jako nazwę aplikacji. Możesz pozostawić pola URL bez zmian. Dla "Scopes" wymagane są tylko "write:media" i "write:statuses".',
      ...
      'Hide Pheme Branding on Public Pages' => 'Ukryj branding Pheme na publicznych stronach',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Jeśli odwiedzający nie jest zapisany i odwiedza stronę główną Pheme, możesz automatycznie przekierować go na podany tutaj URL. Pozostaw puste, aby domyślnie przekierować go do strony logowania.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Jeśli opcja jest włączona, Pheme będzie automatycznie nagrywał wszystkie transmisje na żywo wykonane na tej stacji w celu nadawania nagrań.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Jeśli włączone, Pheme połączy się z bazą danych MusicBrainz, aby spróbować znaleźć ISRC dla każdego pliku, w którym brakuje tej wartości. Wyłączenie tego może poprawić wydajność.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Jeśli zaznaczone, branding Pheme zostanie usunięty ze stron publicznych.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Dowiedz się więcej o kanałach wydawniczych w dokumentacji Pheme.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Uwaga: Powinna to być dostępna publicznie strona główna radiostacji, nie adres URL Pheme. Będzie ona zawarta w szczegółach nadawania.',
      'Now' => 'Teraz',
      'Now Playing' => 'Teraz
Odtwarzane',
      ...
      'Settings' => 'Ustawienia',
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Instrukcje dotyczące instalacji oprogramowania do nadawania są dostępne na wiki Pheme.',
      'SFTP Host' => 'Host SFTP',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS nie jest wolnym oprogramowaniem, a jego restrykcyjna licencja nie pozwala Pheme na dystrybucję binarki Shoutcast.',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'Pokaż nowe wydania na swoim kanale aktualizacji na stronie głównej Pheme.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'Stereo Tool nie jest darmowym oprogramowaniem, a jego restrykcyjna licencja nie pozwala Pheme na dystrybucję binarki Stereo Tool.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Pheme.' => 'Edytowalne pola tekstowe to obszary, w których możesz wstawić własny kod konfiguracyjny. Sekcje nieedytowalne są generowane automatycznie przez Pheme.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'To jest zaawansowana funkcja i niestandardowy kod nie jest oficjalnie obsługiwany przez Pheme. Możesz zepsuć swoją stację, dodając niestandardowy kod, ale usunięcie go powinno rozwiązać wszelkie problemy.',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Ta nazwa będzie wyświetlana jako nagłówek podrzędny obok loga Pheme, aby pomóc zidentyfikować ten serwer.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Ta kolejka zawiera pozostałe utwory w kolejności, w której zostaną umieszczone w kolejce przez autopilota Pheme (jeśli utwory kwalifikują się do odtworzenia).',
      ...
      'Update' => 'Zaktualizuj',
      'Update Pheme' => 'Zaktualizuj Pheme',
      'Update Pheme via Web' => 'Zaktualizuj Pheme przez WWW',
      ...
      'Use' => 'Użycie',
      'Use (Us)' => 'Użycie (Us)',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Użyj kluczy API do uwierzytelniania z API Pheme przy użyciu tych samych uprawnień co konto użytkownika.',
      ...
      'Wednesday' => 'Środa',
      'Welcome to Pheme!' => 'Witaj w Pheme!',
      'Welcome!' => 'Witaj!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Można ustawić niestandardowy adres URL dla tego strumienia, który Pheme będzie używany przy odwoływaniu się do niego. Pozostaw puste, aby użyć wartości domyślnej.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'To jest wiadomość testowa z Pheme. Jeśli otrzymałeś tę wiadomość, oznacza to, że ustawienia poczty e-mail są poprawnie skonfigurowane.',
      'Test message sent successfully.' => 'Wiadomość testowa wysłana pomyślnie.',
      'Pheme Application Log' => 'Dziennik aplikacji Pheme',
      ...
      'Set Up Pheme' => 'Skonfiguruj Pheme',
      ...
      'New Pheme Stable Release Available' => 'Dostępne jest nowe stabilne wydanie Pheme',
      ...
      'New Pheme Rolling Release Available' => 'Dostępne jest nowe testowe wydanie Pheme',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Możesz śledzić czas wykonania i użycie pamięci każdej strony Pheme lub aplikacji na stronie profilera.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Jeśli do uzyskiwania dostępu do Pheme regularnie używasz różnych adresów URL, powinieneś włączyć ustawienie "Preferuj adres URL przeglądarki".',
      ...
      'Pheme Settings' => 'Ustawienia Pheme',
      ...
      'Pheme Backup' => 'Kopia zapasowa Pheme',
      ...
      'Pheme Initializing...' => 'Inicjowanie Pheme...',
      'Pheme Setup' => 'Instalacja Pheme',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Witamy w Pheme. Poczekaj, aż niektóre kluczowe zależności Pheme zostaną skonfigurowane...',
      'Running Database Migrations' => 'Uruchamianie migracji bazy danych',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme został zaktualizowany do najnowszej wersji!',
      'Pheme installation complete!' => 'Instalacja Pheme zakończona!',
      ...
      'Pheme Installer' => 'Instalator Pheme',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Witamy w Pheme! Ukończ konfigurację serwera odpowiadając na kilka pytań.',
      'Pheme Updater' => 'Narzędzie Aktualizacji Pheme',
      'Change installation settings?' => 'Zmienić ustawienia instalacji?',
      'Pheme is currently configured to listen on the following ports:' => 'Pheme jest obecnie skonfigurowany do nasłuchiwania na następujących portach:',
      'HTTP Port: %d' => 'Port HTTP: %d',
      'HTTPS Port: %d' => 'Port HTTPS: %d',
      'SFTP Port: %d' => 'Port SFTP: %d',
      'Radio Ports: %s' => 'Porty radiowe: %s',
      'Customize ports used for Pheme?' => 'Dostosować używane porty dla Pheme?',
      ...
      'This file was automatically generated by Pheme.' => 'Ten plik został wygenerowany automatycznie przez Pheme.',
      ...
      'HTTP Port' => 'Port HTTP',
      'The main port Pheme listens to for insecure HTTP connections.' => 'Główny port, jakiego Pheme używa do nasłuchiwania niezabezpieczonych połączeń HTTP.',
      'HTTPS Port' => 'Port HTTPS',
      'The main port Pheme listens to for secure HTTPS connections.' => 'Główny port, jakiego Pheme używa do nasłuchiwania zabezpieczonych połączeń HTTPS.',
      'The port Pheme listens to for SFTP file management connections.' => 'Port, na jakim Pheme nasłuchuje połączeń zarządzania plikami poprzez SFTP.',
      'Station Ports' => 'Porty stacji',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'Porty, na których Pheme powinien nasłuchiwać strumieni stacji oraz przychodzących połączeń prezenterów.',
