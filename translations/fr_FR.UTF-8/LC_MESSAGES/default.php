<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Tous les noms de domaine présents dans cette liste doivent pointer vers cette installation Pheme. Si vous souhaitez utiliser plusieurs noms de domaine, séparez-les par des virgules.',
      ...
      'Any of the following file types are accepted:' => 'Les types de fichiers suivants sont acceptés :',
      ...
      'Pheme First-Time Setup' => 'Pheme Première installation',
      'Pheme Instance Name' => 'Nom de l\'instance Pheme',
      'Pheme ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'Pheme est livré avec une base de données de géolocalisation IP gratuite intégrée. Vous préférerez peut-être utiliser le service MaxMind GeoLite pour obtenir des résultats plus précis. L\'utilisation de MaxMind GeoLite nécessite une clé de licence, mais une fois la clé fournie, nous garderons automatiquement la base de données à jour.',
      'Pheme Update Checks' => 'Vérifier les mises à jour d\'Pheme',
      'Pheme User' => 'Utilisateur Pheme',
      'Pheme uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Pheme utilise un système de contrôle d\'accès basé sur les rôles. Les rôles permettent l\'accès à certaines sections du site aux utilisateurs possédants les rôles.',
      'Pheme Wiki' => 'Wiki Pheme',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme analysera le fichier téléchargé à la recherche de correspondances dans la bibliothèque musicale de cette station. Les médias doivent déjà être téléchargés avant de passer à cette étape. Vous pouvez relancer cet outil autant de fois que nécessaire.',
      'AzuraRelay is a standalone service that connects to your Pheme instance, automatically relays your stations via its own server, then reports the listener details back to your main instance. This page shows all currently connected instances.' => 'AzuraRelay est un service autonome qui se connecte à votre instance Pheme, relaie automatiquement vos stations via son propre serveur, puis rapporte les détails des auditeurs à votre instance principale. Cette page affiche toutes les instances actuellement connectées.',
      'Back' => 'Retour',
      ...
      'Create a new application. Choose "Scoped Access", select your preferred level of access, then name your app. Do not name it "Pheme", but rather use a name specific to your installation.' => 'Créer une nouvelle application. Choisissez "Accès limité", sélectionnez votre niveau d\'accès préféré, puis nommez votre application. Ne le nommez pas "Pheme", mais utilisez plutôt un nom propre à votre installation.',
      ...
      'Customize Pheme Settings' => 'Personnaliser les paramètres d\'Pheme',
      ...
      'Default Live Broadcast Message' => 'Message par défaut lors du démarrage d\'une diffusion en direct',
      ...
      'Donate to support Pheme!' => 'Faire un don pour soutenir Pheme !',
      'Down' => 'En bas',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Permet à Pheme d\'exécuter automatiquement des sauvegardes de nuit à l\'heure spécifiée.',
      ...
      'Enter "Pheme" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Entrez "Pheme" comme nom de l\'application. Vous pouvez laisser tel quel le champ URL. Pour "Scopes", sont nécessaires seulement "write:media" et "write.statuses".',
      ...
      'Hide Pheme Branding on Public Pages' => 'Masquer la marque Pheme sur les pages publiques',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Si un visiteur n\'est pas connecté et visite la page d\'accueil d\'Pheme, vous pouvez le rediriger automatiquement vers l\'URL indiquée ici. Laissez vide pour les rediriger vers l\'écran de connexion par défaut.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Si cette option est activée, Pheme enregistrera automatiquement toutes les diffusions en direct effectuées sur cette station dans des enregistrements par diffusion.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Si activé, Pheme se connectera à la base de données MusicBrainz pour tenter de trouver un ISRC pour tous les fichiers manquants. Désactiver cette option peut améliorer les performances du système.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Si cette option est sélectionnée, la marque Pheme sera supprimée des pages destinées au public.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'En savoir plus sur les canaux de diffusion dans la documentation d\'Pheme.',
      'Learn More about Replaygain' => 'En savoir plus sur Replaygain',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Remarque : Ceci devrait être la page d\'accueil de la station de radio, et non l\'URL Pheme. Il sera inclus dans les détails de la diffusion.',
      'Notes' => 'Notes',
      'Notice' => 'Remarque',
      'Now' => 'Maintenant',
      ...
      'Powered by Pheme' => 'Propulsé par Pheme',
      ...
      'Settings' => 'Paramètres',
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Les instructions d\'installation pour les logiciels de diffusion sont disponibles sur le wiki d\'Pheme.',
      'SFTP Host' => 'Hôte SFTP',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'SHOUTcast 2 DNAS n\'est pas un logiciel gratuit, et sa licence restrictive ne permet pas à Pheme de distribuer le binaire Shoutcast.',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'Afficher les nouvelles versions dans votre canal de mise à jour sur la page d\'accueil d\'Pheme.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'Stéréo Tool n\'est pas un logiciel libre. Sa licence restrictive ne permet pas à Pheme de distribuer le binaire de Stéréo Tool.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Pheme.' => 'Les zones de texte modifiables sont des zones où vous pouvez insérer du code de configuration personnalisé. Les sections non modifiables sont automatiquement générées par Pheme.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Il s\'agit d\'une fonctionnalité avancée et le code personnalisé n\'est pas officiellement pris en charge par Pheme. Vous pouvez casser votre station en ajoutant du code personnalisé, mais le supprimer devrait résoudre tous les problèmes.',
      ...
      'This mode disables Pheme\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.' => 'Ce mode désactive la gestion d\'AutoDJ d\'Pheme, en utilisant Liquidsoap lui-même pour gérer la lecture des chansons. "Chanson suivante" et d\'autres fonctionnalités ne seront pas disponibles.',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Ce nom va apparaître comme sous-titre à côté du logo d\'Pheme, pour vous aider à identifier ce serveur.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Cette file d\'attente contient les pistes restantes dans l\'ordre dans lequel elles seront mises en file d\'attente par l\'AutoDJ Pheme (si les pistes sont éligibles pour être jouées).',
      ...
      'To customize installation settings, or if automatic updates are disabled, you can follow our standard update instructions to update via your SSH console.' => 'Pour modifier les paramètres d\'installation ou si les mises à jour automatiques sont désactivées, veuillez suivre les instructions de mise à jour classique pour mettre à jour Pheme via votre console SSH.',
      ...
      'Update' => 'Mise à jour',
      'Update Pheme' => 'Mettre à jour Pheme',
      'Update Pheme via Web' => 'Mettre à jour Pheme via l\'interface Web',
      'Update Pheme? Your installation will restart.' => 'Mettre à jour Pheme ? Votre installation va redémarrer.',
      ...
      'Use' => 'Utilisé',
      'Use (Us)' => 'Utilisé (Us)',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Utilisez les clés API pour vous authentifier avec l\'API Pheme en utilisant les mêmes permissions que votre compte utilisateur.',
      ...
      'Wednesday' => 'Mercredi',
      'Weight' => 'Poids',
      'Welcome to Pheme!' => 'Bienvenue sur Pheme !',
      'Welcome!' => 'Bienvenue!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Vous pouvez définir une URL personnalisée pour ce flux qu\'Pheme utilisera pour s\'y référer. Laissez vide pour utiliser la valeur par défaut.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Ceci est un message de test d\'Pheme. Si vous recevez ce message, cela signifie que vos paramètres de messagerie sont configurés correctement.',
      'Test message sent successfully.' => 'Message de test envoyé avec succès.',
      'Pheme Application Log' => 'Logs de l\'application Pheme',
      'Pheme Now Playing Log' => 'Logs des lectures en cours Pheme',
      'Pheme Synchronized Task Log' => 'Logs des tâches synchronisées Pheme',
      'Pheme Queue Worker Log' => 'Logs des traitements des files d\'attentes Pheme',
      ...
      'New Pheme Stable Release Available' => 'Nouvelle version stable d\'Pheme disponible',
      ...
      'New Pheme Rolling Release Available' => 'Nouvelle version de roulement d\'Pheme disponible',
      ...
      'Pheme is free and open-source software.' => 'Pheme est un logiciel gratuit et open-source.',
      'If you are enjoying Pheme, please consider donating to support our work. We depend on donations to build new features, fix bugs, and keep Pheme modern, accessible and free.' => 'Si vous appréciez Pheme, pensez à faire un don pour soutenir notre travail. Nous dépendons des dons pour construire de nouvelles fonctionnalités, corriger des bugs et rendre Pheme moderne, accessible et gratuit.',
      'Donate to Pheme' => 'Faire un don à Pheme',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Vous pouvez suivre le temps d\'exécution et l\'utilisation de la mémoire de n\'importe quelle page Pheme ou application à partir de la page du profileur.',
      ...
      'This likely means that multiple Pheme instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.' => 'Cela signifie probablement que plusieurs instances Pheme se connectent à la même base de données. Cette instance actuelle n\'est pas active, donc les tâches synchronisées ne s\'exécuteront pas sur ce serveur. Si cela est intentionnel, vous pouvez ignorer ce message.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Si vous utilisez régulièrement différentes URL pour accéder à Pheme, vous devriez activer l\'option "URL du navigateur préféré".',
      ...
      'Pheme Initializing...' => 'Initialisation d\'Pheme ...',
      'Pheme Setup' => 'Installation d\'Pheme',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Bienvenue sur Pheme. Veuillez patienter pendant que quelques dépendances clés d\'Pheme sont mises en place...',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme est maintenant mis à jour vers la dernière version !',
      'Pheme installation complete!' => 'L\'installation d\'Pheme est terminée !',
      ...
      'Pheme Installer' => 'Installateur d\'Pheme',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Bienvenue sur Pheme ! Complétez la configuration initiale du serveur en répondant à quelques questions.',
      'Pheme Updater' => 'Mise à jour d\'Pheme',
      'Change installation settings?' => 'Modifier les paramètres d\'installation ?',
      'Pheme is currently configured to listen on the following ports:' => 'Pheme est actuellement configuré pour écouter sur les ports suivants :',
      'HTTP Port: %d' => 'Port HTTP : %d',
      'HTTPS Port: %d' => 'Port HTTPS : %d',
      'SFTP Port: %d' => 'Port SFTP : %d',
      'Radio Ports: %s' => 'Ports radio : %s',
      'Customize ports used for Pheme?' => 'Personnaliser les ports utilisés pour Pheme ?',
      ...
      'This file was automatically generated by Pheme.' => 'Ce fichier a été généré automatiquement par Pheme.',
      ...
      'HTTP Port' => 'Port HTTP',
      'The main port Pheme listens to for insecure HTTP connections.' => 'Le port principal qu\'Pheme écoute pour les connexions HTTP non sécurisées.',
      'HTTPS Port' => 'Port HTTPS',
      'The main port Pheme listens to for secure HTTPS connections.' => 'Le port principal qu\'Pheme écoute pour des connexions HTTPS sécurisées.',
      'The port Pheme listens to for SFTP file management connections.' => 'Le port d\'écoute d\'Pheme pour les connexions de gestion de fichiers SFTP.',
      'Station Ports' => 'Ports de la station',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'Les ports qu\'Pheme devra écouter pour les diffusions des stations et les connexions DJ entrantes.',
