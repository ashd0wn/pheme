<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Alle aufgeführten Domainnamen sollten auf diese Pheme-Installation verweisen. Trennen Sie mehrere Domainnamen mit Kommas.',
      ...
      'Pheme First-Time Setup' => 'Pheme Erstinstallation',
      'Pheme Instance Name' => 'Pheme Instanz Name',
      'Pheme ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'Pheme wird mit einer eingebauten kostenlosen IP-Geolokalisierungsdatenbank geliefert. Du kannst stattdessen auch den MaxMind GeoLite Service nutzen, um genauere Ergebnisse zu erzielen. Die Verwendung von MaxMind GeoLite erfordert einen Lizenzschlüssel, aber sobald der Schlüssel zur Verfügung gestellt wird, halten wir die Datenbank automatisch aktualisiert.',
      'Pheme Update Checks' => 'AzureCast Update-Überprüfungen',
      'Pheme User' => 'Pheme Benutzer',
      'Pheme uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Pheme verwendet ein rollenbasiertes Zugriffskontrollsystem. Rollen werden Berechtigungen für bestimmte Bereiche der Website zugewiesen, dann werden Benutzer diesen Rollen zugewiesen.',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme wird die hochgeladene Datei nach Übereinstimmungen in der Musikbibliothek des Senders durchsuchen. Die Medien sollten bereits hochgeladen sein, bevor dieser Schritt ausgeführt wird. Dieses Tool kann so oft wie nötig erneut ausgeführt werden.',
      'Back' => 'Zurück',
      ...
      'Customize Pheme Settings' => 'Pheme Einstellungen anpassen',
      ...
      'Donate to support Pheme!' => 'Spenden Sie, um Pheme zu unterstützen!',
      'Down' => 'Nach unten',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Aktivieren, um Pheme automatisch Nachtbackups zu der angegebenen Zeit ausführen zu lassen.',
      ...
      'Enter "Pheme" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Geben Sie "Pheme" als Anwendungsname ein. Sie können die URL-Felder unverändert lassen. Für „Scopes“ sind nur "write:media" und "write:statuses" erforderlich.',
      ...
      'Hide Pheme Branding on Public Pages' => 'Blenden Sie Pheme Branding auf öffentlichen Seiten aus',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Wenn ein Besucher nicht eingeloggt und die Pheme Homepage besucht, können Sie sie automatisch mit der hier angegebenen URL umleiten. Freilassen Sie, um sie zum Login-Bildschirm standardmäßig umzuleiten.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Wenn diese Option aktiviert ist, nimmt Pheme automatisch alle Live-Übertragungen dieses Senders auf und speichert sie.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Wenn aktiviert, wird sich Pheme mit der MusicBrainz Datenbank verbinden, um zu versuchen, einen ISRC für alle Dateien zu finden, in denen dieser fehlt. Deaktivieren kann die Leistung verbessern.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Wenn ausgewählt, wird dadurch das Pheme branding auf öffentlich zugänglichen Seiten nicht angezeigt.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Mehr Informationen über Release Kanäle findest du in den Pheme Docs.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Hinweis: Dies sollte die öffentlich zugänglichen Homepage des Radiosenders sein, nicht die Pheme URL. Sie wird in die Übertragungs-Details aufgenommen.',
      'Now' => 'Jetzt',
      ...
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Anleitungen für die Einrichtung der Broadcasting-Software sind im Pheme Wiki zu finden.',
      'SFTP Host' => 'SFTP: Host',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS ist keine freie Software, und die restriktive Lizenz erlaubt es Pheme nicht, die Shoutcast-Binärdatei zu vertreiben.',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'Neue Releases in deinem Update-Kanal auf der Pheme Homepage anzeigen.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'Stereo Tool ist keine freie Software und die restriktive Lizenz erlaubt es Pheme nicht, das Stereo Tool Binary zu vertreiben.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Pheme.' => 'Die editierbaren Textfelder sind Bereiche, in die eigener Konfigurationscode einfügt werden kann. Die nicht editierbaren Bereiche werden automatisch von Pheme generiert.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Dies ist eine erweiterte Funktion und benutzerdefinierter Code wird nicht offiziell von Pheme supported. Es kann sein, dass dein Sender durch das Hinzufügen von benutzerdefiniertem Code gestört wird, aber das Entfernen des Codes sollte alle Probleme beheben.',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Dieser Name erscheint als Sub-Header neben dem Pheme-Logo, um diesen Server zu identifizieren.',
      ...
      'Update' => 'Änderung',
      'Update Pheme' => 'Pheme aktualisieren',
      'Update Pheme via Web' => 'Pheme via Web aktualisieren',
      ...
      'Use' => 'Benutzen',
      'Use (Us)' => 'in benutzung',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Verwende API-Schlüssel, um dich bei der Pheme API mit den Berechtigungen deines Benutzerkonto zu authentifizieren.',
      ...
      'Wednesday' => 'Mittwoch',
      'Welcome to Pheme!' => 'Willkommen bei Pheme!',
      'Welcome!' => 'Willkommen!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Sie können eine benutzerdefinierte URL für den Stream festlegen, die von Pheme benutzt wird. Lassen Sie es frei, um den Standardwert verwenden.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Dies ist eine Testnachricht von Pheme. Wenn Sie diese Nachricht erhalten, bedeutet dies, dass Ihre E-Mail-Einstellungen korrekt konfiguriert sind.',
      'Test message sent successfully.' => 'Testnachricht erfolgreich gesendet.',
      'Pheme Application Log' => 'Pheme-Anwendungsprotokoll',
      ...
      'New Pheme Stable Release Available' => 'Neues Pheme Stable Release verfügbar',
      ...
      'New Pheme Rolling Release Available' => 'Neues Pheme Rolling Release verfügbar',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Die Ausführungszeiten und die Speichernutzung jeder Pheme-Seite oder -Anwendung kann auf der Profiler-Seite verfolgt werden.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Wenn regelmäßig verschiedene URLs für den Zugriff auf Pheme verwendet werden, sollte die Einstellung " Bevorzuge Browser URL" aktiviert werden.',
      ...
      'Pheme Initializing...' => 'Pheme Initialisierung...',
      'Pheme Setup' => 'Pheme Setup',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Willkommen bei Pheme. Bitte warten, während einige Schlüsselabhängigkeiten von Pheme eingerichtet werden...',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme ist aktuell!',
      'Pheme installation complete!' => 'Pheme-Installation abgeschlossen!',
      ...
      'Pheme Installer' => 'Pheme Installer',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Willkommen bei Pheme! Vervollständigen Sie die anfängliche Servereinrichtung, indem Sie einige Fragen beantworten.',
      'Pheme Updater' => 'Pheme Updater',
      'Change installation settings?' => 'Installationseinstellungen ändern?',
      'Pheme is currently configured to listen on the following ports:' => 'Pheme ist derzeit so konfiguriert, dass es die folgenden Ports benutzt:',
      'HTTP Port: %d' => 'HTTP Port: %d',
      'HTTPS Port: %d' => 'HTTPS Port: %d',
      'SFTP Port: %d' => 'SFTP Port: %d',
      'Radio Ports: %s' => 'Radio Ports: %s',
      'Customize ports used for Pheme?' => 'Ports für Pheme anpassen?',
      ...
      'This file was automatically generated by Pheme.' => 'Diese Datei wurde automatisch von Pheme generiert.',
      ...
      'HTTP Port' => 'HTTP Port',
      'The main port Pheme listens to for insecure HTTP connections.' => 'Der Hauptport, den Pheme für unsichere HTTP-Verbindungen nutzt.',
      'HTTPS Port' => 'HTTPS Port',
      'The main port Pheme listens to for secure HTTPS connections.' => 'Der Haupt-Port, den Pheme bei sicheren HTTPS-Verbindungen nutzt.',
      'The port Pheme listens to for SFTP file management connections.' => 'Der Port, den Pheme bei SFTP-Dateimanagement-Verbindungen nutzt.',
      'Station Ports' => 'Sender Ports',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'Die Ports, die Pheme für Sender-Übertragungen und eingehende DJ-Verbindungen benutzen soll.',
