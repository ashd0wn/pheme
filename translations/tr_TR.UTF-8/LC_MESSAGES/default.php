<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Pheme First-Time Setup' => 'Pheme İlk Kurulumu',
      'Pheme Instance Name' => 'Pheme Slogan İsmi',
      'Pheme ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'Pheme yerleşik bir ücretsiz IP konum belirleme veritabanıyla birlikte gelir. Daha doğru sonuçlar elde etmek için MaxMind GeoLite hizmetini kullanmayı tercih edebilirsiniz. MaxMind GeoLite kullanmak bir lisans anahtarı gerektirir ancak anahtar sağlandıktan sonra veritabanını otomatik olarak güncel tutacağız.',
      'Pheme Update Checks' => 'Pheme Güncelleme Kontrolleri',
      'Pheme User' => 'Pheme Kullanıcısı',
      'Pheme uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Pheme yetki tabanlı bir erişim kontrol sistemi kullanır. Yetkilerle sitenin belirli bölümlerine izin verilir ve ardından kullanıcılar bu yetkilere atanır.',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme yüklenen dosyayı bu istasyonun müzik kitaplığındaki eşleşmelere karşı tarar. Bu adımı çalıştırmadan önce medya zaten yüklenmiş olmalıdır. Bu aracı gerektiği kadar tekrar çalıştırabilirsiniz.',
      'Back' => 'Geri',
      'Backup' => 'Yedek',
      ...
      'Customize Pheme Settings' => 'Pheme Ayarlarını Özelleştir',
      ...
      'Donate to support Pheme!' => 'Bizi desteklemek için bağış yapın!',
      'Down' => 'Aşağı',
      'Download' => 'İndir',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Pheme her gece belirtilen saatte otomatik olarak yedekleme yapmasını etkinleştirin.',
      ...
      'Hide Pheme Branding on Public Pages' => 'Pheme Markasını Gizle',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Bir ziyaretçi oturum açmamışsa ve Pheme anasayfasını ziyaret ediyorsa onları otomatik olarak burada belirtilen URLye yönlendirebilirsiniz. Varsayılan olarak giriş ekranına yönlendirmek için boş bırakın.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Etkinleştirilirse, Pheme bu istasyona yapılan tüm canlı yayınları yayın başına kayıtlara otomatik olarak kaydeder.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Etkinleştirilirse, Pheme eksik olan tüm dosyalar için bir ISRC bulmaya çalışmak üzere MusicBrainz veritabanına bağlanacaktır. Bunu devre dışı bırakmak performansı artırabilir.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Pheme markasını genel sayfa ve giriş ekranından gizlemek için etkinleştirin.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Pheme belgelerinde yayın kanalları hakkında daha fazla bilgi edinin.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Not: Pheme URLsi değil radyonuzun web adresi olmalıdır. Yayın detaylarına eklenecektir.',
      'Now' => 'Şimdi',
      ...
      'Settings' => 'Ayarlar',
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Canlı yayın programlarına ait dökümanlar için Pheme Wiki sayfasını ziyaret edebilirsiniz.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS özgür yazılım değildir ve kısıtlayıcı lisansı Pheme\'ın Shoutcast dosyasını dağıtmasına izin vermez.',
      'Shoutcast License ID' => 'Shoutcast Lisans ID',
      'Shoutcast User ID' => 'SHOUTcast Kullanıcı ID',
      'Show new releases within your update channel on the Pheme homepage.' => 'Pheme anasayfasında güncelleme kanalınızda yeni sürümleri gösterin.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'Stereo Aracı ücretsiz bir yazılım değildir ve kısıtlayıcı lisansı Pheme\'ın Stereo Araç ikili dosyasını dağıtmasına izin vermez.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Bu gelişmiş bir özelliktir ve özel kod Pheme tarafından resmi olarak desteklenmemektedir. Özel kod ekleyerek radyonuzu bozabilirsiniz ancak onu kaldırmak tüm sorunları çözecektir.',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Pheme logosunun yanında yer alacak slogan adını yazın.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Bu sıra kalan parçaları Pheme AutoDJ tarafından sıraya alınacakları sıraya göre içerir (parçalar oynatılmaya uygunsa).',
      ...
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Kullanıcı hesabınızla aynı izinleri kullanarak Pheme API ile kimlik doğrulaması yapmak için API anahtarlarını kullanın.',
      ...
      'Username:' => 'Kullanıcı Adı:',
      'Users' => 'Kullanıcılar',
      'Users with this role will have these permissions across the entire installation.' => 'Bu yetkiye sahip kullanıcılar Pheme yönetimi üzerinde bu izinlere sahip olacaktır.',
      ...
      'Wednesday' => 'Çarşamba',
      'Welcome to Pheme!' => 'Pheme\'e Hoşgeldiniz!',
      'Welcome!' => 'Hoşgeldiniz!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Bu yayının Pheme de kullanılacağı özel bir URL belirleyebilirsiniz. Varsayılan değeri kullanmak için boş bırakın.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Bu Pheme\'tan bir test mesajıdır. Bu mesajı alıyorsanız e-posta ayarlarınızın doğru yapılandırıldığı anlamına gelir.',
      'Test message sent successfully.' => 'Test mesajı başarıyla gönderildi.',
      'Pheme Application Log' => 'Pheme Günlüğü',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Profil oluşturucu sayfasından herhangi bir Pheme sayfasının veya uygulamasının yürütme süresini ve bellek kullanımını izleyebilirsiniz.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Pheme\'a erişmek için düzenli olarak farklı URL\'ler kullanıyorsanız, "Tarayıcı URLsini Tercih Et" ayarını etkinleştirmelisiniz.',
      ...
      'Pheme Setup' => 'Pheme Kurulumu',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Pheme\'a hoşgeldiniz. Pheme’in bazı temel sistemleri kurulurken lütfen bekleyin...',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme şimdi en son sürüme güncellendi!',
      'Pheme installation complete!' => 'Pheme kurulumu tamamlandı!',
      ...
      'Pheme Installer' => 'Pheme Yükleyici',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Pheme\'a hoş geldiniz! Birkaç soruyu yanıtlayarak ilk sunucu kurulumunu tamamlayın.',
      'Pheme Updater' => 'Pheme Güncelleyici',
      'Change installation settings?' => 'Kurulum ayarları değiştirilsin mi?',
      'Pheme is currently configured to listen on the following ports:' => 'Pheme şu anda aşağıdaki port numaralarını kullanacak şekilde yapılandırılmıştır:',
      'HTTP Port: %d' => 'HTTP Portu: %d',
      'HTTPS Port: %d' => 'HTTPS Portu: %d',
      'SFTP Port: %d' => 'SFTP Portu: %d',
      'Radio Ports: %s' => 'Radyo Canlı Yayın Portları: %s',
      'Customize ports used for Pheme?' => 'Pheme için kullanılacak port numaraları özelleştirilsin mi?',
      ...
      'This file was automatically generated by Pheme.' => 'Bu dosya Pheme tarafından otomatik olarak oluşturulmuştur.',
      ...
      'The main port Pheme listens to for insecure HTTP connections.' => 'Pheme ana bağlantı noktası güvenli olmayan HTTP bağlantılarını dinler.',
      'HTTPS Port' => 'HTTPS Portu',
      'The main port Pheme listens to for secure HTTPS connections.' => 'Pheme ana bağlantı noktası güvenli HTTPS bağlantılarını dinler.',
      'The port Pheme listens to for SFTP file management connections.' => 'Pheme bağlantı noktası SFTP dosya yönetimi bağlantılarını dinler.',
      'Station Ports' => 'Radyo Yayın Portları',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'Pheme bağlantı noktaları radyo yayınlarını ve gelen DJ bağlantılarını dinlemelidir.',
