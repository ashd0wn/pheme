<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Album' => 'Album',
      'Album Art' => 'Albumhoes',
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Alle vermelde domeinnamen moeten naar deze Pheme installatie wijzen. Scheid meerdere domeinnamen met komma\'s.',
      ...
      'Pheme First-Time Setup' => 'Pheme installatie',
      'Pheme Instance Name' => 'Pheme: Stations Naam',
      'Pheme ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'Pheme werkt met een ingebouwde gratis IP geolocatie database. U kunt in plaats daarvan de MaxMind GeoLite gebruiken om nauwkeurigere resultaten te bereiken. Het gebruik van MaxMind GeoLite vereist een licentiesleutel, maar zodra de sleutel is ingevult, zullen we de database automatisch op de hoogte houden.',
      'Pheme Update Checks' => 'Pheme update controles',
      'Pheme User' => 'Pheme gebruiker',
      'Pheme uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Pheme gebruikt een op rol gebaseerd toegangscontrolesysteem. Rollen krijgen machtigingen voor bepaalde delen van de site, waarna gebruikers worden toegewezen aan deze rollen.',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme zal het geüploade bestand scannen voor overeenkomsten in de muziekbibliotheek van dit station. Media dient geüpload te zijn voor deze stap wordt uitgevoerd. Je kunt deze tool opnieuw uitvoeren, zo vaak als nodig is.',
      'Back' => 'Terug',
      ...
      'Customize Pheme Settings' => 'Pheme instellingen aanpassen',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Inschakelen om Pheme automatisch nachtelijke back-ups te laten uitvoeren op het opgegeven tijdstip.',
      ...
      'Hide Pheme Branding on Public Pages' => 'Verberg Pheme reclame op openbare pagina\'s',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Als een bezoeker niet is aangemeld en de homepage van Pheme bezoekt, kunt u ze automatisch doorverwijzen naar de hier opgegeven URL. Laat leeg om ze standaard naar het login scherm te verwijzen.',
      ...
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Indien ingeschakeld, zal Pheme verbinding maken met de MusicBrainz database om te proberen een ISRC te vinden voor bestanden waar er een ontbreekt. Het uitschakelen hiervan kan de prestaties verbeteren.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Indien geselecteerd, zal dit Pheme reclame van publieke pagina\'s verwijderen.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Meer informatie over release kanalen in de Pheme documentatie.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Opmerking: Dit moet de publieke startpagina van het radiostation zijn, niet de Pheme pagina. Deze website zal worden opgenomen in de uitzendgegevens.',
      'Now' => 'Nu',
      ...
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Instructies voor het instellen van uitzendingssoftware zijn beschikbaar op de Pheme wiki.',
      'SFTP Port' => 'SFTP-poort',
      'SFTP Users' => 'SFTP gebruikers',
      'Show new releases within your update channel on the Pheme homepage.' => 'Toon nieuwe releases binnen uw release-kanaal op de Pheme homepage.',
      ...
      'The date when the episode should be published.' => 'De datum waarop de aflevering moet worden gepubliceerd.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Pheme.' => 'De bewerkbare tekstvakken zijn gebieden waar u aangepaste configuratiecode kunt invoegen. De niet-bewerkbare secties worden automatisch gegenereerd door Pheme.',
      ...
      'The time when the episode should be published (according to the stations timezone).' => 'De tijd wanneer de aflevering moet worden gepubliceerd (volgens de tijdzone van de station).',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Dit is een geavanceerde functie en aangepaste code wordt niet officieel ondersteund door Pheme. U kunt uw station kapot maken door een aangepaste code toe te voegen, maar het verwijderen kan problemen oplossen.',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Deze naam wordt weergegeven als subtitel naast het Pheme logo, ter herkenning van deze server.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Deze wachtrij bevat de resterende nummers in de volgorde waarin ze in de wachtrij staan door de Pheme AutoDJ (als de nummers in aanmerking komen om af te spelen).',
      ...
      'This will be the file name for your backup, include the extension for file type you wish to use.' => 'Dit wordt de bestandsnaam van uw back-up, voeg de extensie toe voor het bestandstype dat u wilt gebruiken.',
      ...
      'Use' => 'Gebruik',
      'Use (Us)' => 'Gebruik (ons)',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Gebruik API-sleutels om te verifiëren met de Pheme API met dezelfde rechten als uw gebruikersaccount.',
      ...
      'Wednesday' => 'Woensdag',
      'Welcome to Pheme!' => 'Welkom bij Pheme!',
      'Welcome!' => 'Welkom!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'U kunt een aangepaste URL instellen voor de stream die door Pheme wordt gebruikt. Laat leeg om de standaardwaarde te gebruiken.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Dit is een testbericht van Pheme. Als u dit bericht ontvangt, betekent dit dat uw e-mailinstellingen correct zijn geconfigureerd.',
      'Test message sent successfully.' => 'Test Bericht succesvol verzonden.',
      'Pheme Application Log' => 'Pheme applicatielog',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'U kunt de uitvoeringstijd en het geheugengebruik van elke Pheme-pagina of -toepassing volgen vanaf de profielpagina.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Als u regelmatig verschillende URL\'s gebruikt om toegang te krijgen tot Pheme, moet u de "Voorkeur Browser URL" instelling aanzetten.',
      ...
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Welkom bij Pheme. Een ogenblik geduld terwijl enkele code afhankelijkheden worden ingesteld...',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme is bijgewerkt naar de laatste versie!',
      'Pheme installation complete!' => 'De installatie van Pheme is voltooid!',
      ...
      'Pheme Installer' => 'Pheme installatieprogramma',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Welkom bij Pheme! Voltooi de initiële server installatie door enkele vragen te beantwoorden.',
      'Pheme Updater' => 'Pheme Updater',
      'Change installation settings?' => 'Installatie instellingen wijzigen?',
      'Pheme is currently configured to listen on the following ports:' => 'Pheme is momenteel geconfigureerd om te luisteren op de volgende poorten:',
      'HTTP Port: %d' => 'HTTP poort: %d',
      'HTTPS Port: %d' => 'HTTPS poort: %d',
      'SFTP Port: %d' => 'SFTP poort: %d',
      'Radio Ports: %s' => 'Radio poorten: %s',
      'Customize ports used for Pheme?' => 'Poorten aanpassen die worden gebruikt door AzureCast?',
      'Writing configuration files...' => 'Configuratiebestanden genereren...',
      'Server configuration complete!' => 'Serverconfiguratie voltooid!',
      'This file was automatically generated by Pheme.' => 'Dit bestand is automatisch gegenereerd door Pheme.',
      ...
      'The main port Pheme listens to for insecure HTTP connections.' => 'De hoofdpoort waar Pheme naar luistert voor onveilige HTTP-verbindingen.',
      'HTTPS Port' => 'HTTPS-poort',
      'The main port Pheme listens to for secure HTTPS connections.' => 'De hoofdpoort waar Pheme naar luistert voor veilige HTTPS-verbindingen.',
      'The port Pheme listens to for SFTP file management connections.' => 'De poort waar Pheme naar luistert voor SFTP-bestandsbeheerverbindingen.',
      'Station Ports' => 'Station poorten',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'De poorten waarnaar Pheme moet luisteren voor zenderuitzendingen en inkomende DJ-verbindingen.',
