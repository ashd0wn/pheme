<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Album' => 'Album',
      'Album Art' => 'Obal alba',
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Veškéré domény by měli odkazovat na tuto instalaci Pheme. Oddělte více domén čárkami.',
      ...
      'Pheme First-Time Setup' => 'První nastavení Pheme',
      'Pheme Instance Name' => 'Název instance Pheme',
      'Pheme ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'Pheme je vybavena bezplatnou IP geolokační databází. Můžete raději použít službu MaxMind GeoLite pro dosažení přesnějších výsledků. Použití MaxMind GeoLite vyžaduje licenční klíč, ale jakmile je klíč poskytnut, budeme databázi automaticky aktualizovat.',
      'Pheme Update Checks' => 'Kontrola aktualizací Pheme',
      'Pheme User' => 'Uživatel Pheme',
      'Pheme uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Pheme používá systém řízení přístupu založený na rolích. Role mají oprávnění pro určité části webu, uživatelé jsou poté přiřazeni k těmto rolím.',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme naskenuje nahraný soubor pro výsledky v hudební knihovně této stanice. Média by měla být nahrána ještě před spuštěním tohoto kroku. Tento nástroj můžete spustit znovu, kolikrát je potřeba.',
      'Back' => 'Zpět',
      ...
      'Customize Pheme Settings' => 'Přizpůsobit nastavení Pheme',
      ...
      'Donate to support Pheme!' => 'Podpořit Pheme!',
      'Down' => 'Dolů',
      'Download' => 'Stáhnout',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Povolit, aby Pheme v určeném čase automaticky spouštěla noční zálohování.',
      ...
      'Enter "Pheme" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Jako název aplikace zadejte "Pheme". Pole URL můžete ponechat beze změny. Pro "Scopes" (Rozsah) jsou vyžadovány pouze položky "write:media" a "write:statuses".',
      ...
      'Hide Pheme Branding on Public Pages' => 'Skrýt Pheme značku na veřejných stránkách',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Pokud není návštěvník přihlášen a navštíví domovskou stránku Pheme, můžete ho automaticky přesměrovat na zde uvedenou URL adresu. Chcete-li ho přesměrovat na výchozí přihlašovací obrazovku, ponechte prázdné.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Pokud je tato funkce povolena, bude Pheme automaticky nahrávat všechna živá vysílání této stanice do nahrávek na vysílání.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Pokud je tato funkce povolena, Pheme se připojí k databázi MusicBrainz a pokusí se najít ISRC pro všechny soubory, u kterých chybí. Vypnutí této funkce může zlepšit výkon.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Pokud je tato možnost vybrána, odstraní se značka Pheme ze stránek, které jsou veřejně přístupné.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Další informace o kanálech vydání najdete v dokumentech k Phemeu.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Poznámka: Toto by měla být veřejná domovská stránka rozhlasové stanice, nikoli adresa URL Pheme. Bude uvedena v podrobnostech o vysílání.',
      'Now' => 'Nyní',
      ...
      'Settings' => 'Nastavení',
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Pokyny k nastavení vysílacího softwaru jsou k dispozici na wiki Pheme.',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'Shoutcast 2 DNAS není free software a jeho omezující licence neumožňuje společnosti Pheme distribuovat binární soubor Shoutcast.',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'Zobrazení nových verzí v rámci aktualizačního kanálu na domovské stránce Phemeu.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'Stereo Tool není free software a jeho omezující licence neumožňuje společnosti Pheme šířit binární soubor Stereo Tool.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Pheme.' => 'Upravitelná textová pole jsou oblasti, do kterých můžete vložit vlastní konfigurační kód. Needitovatelné části jsou automaticky generovány aplikací Pheme.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Jedná se o pokročilou funkci a vlastní kód není oficiálně podporován společností Pheme. Přidáním vlastního kódu můžete stanici poškodit, ale jeho odstraněním by měly být případné problémy odstraněny.',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Tento název se zobrazí jako dílčí záhlaví vedle loga Pheme, aby bylo možné tento server identifikovat.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Tato fronta obsahuje zbývající skladby v pořadí, v jakém je Pheme AutoDJ zařadí do fronty (pokud je možné je přehrát).',
      ...
      'Update' => 'Aktualizovat',
      'Update Pheme' => 'Aktualizovat Pheme',
      'Update Pheme via Web' => 'Aktualizovat Pheme prostřednictvím Webu',
      ...
      'Use' => 'Využito',
      'Use (Us)' => 'Využití (Us)',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Použitím klíčů API se můžete ověřit pomocí rozhraní Pheme API se stejnými oprávněními jako váš uživatelský účet.',
      ...
      'Wednesday' => 'Středa',
      'Welcome to Pheme!' => 'Vítejte v Pheme!',
      'Welcome!' => 'Vítejte!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Pro tento stream můžete nastavit vlastní adresu URL, kterou bude služba Pheme používat, když na ni bude odkazováno. Chcete-li použít výchozí hodnotu, ponechte prázdné.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Toto je testovací zpráva z Phemeu. Pokud tuto zprávu dostáváte, znamená to, že nastavení e-mailu je správně nakonfigurováno.',
      'Test message sent successfully.' => 'Testovací zpráva byla úspěšně odeslána.',
      'Pheme Application Log' => 'Protokol aplikace Pheme',
      ...
      'Set Up Pheme' => 'Nastavení služby Pheme',
      ...
      'New Pheme Stable Release Available' => 'K dispozici je nová stabilní verze Pheme',
      ...
      'New Pheme Rolling Release Available' => 'Nová verze Pheme Rolling Release je k dispozici',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Můžete sledovat čas provádění a využití paměti jakékoli stránky Pheme nebo aplikace z profileru stránky.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Pokud pro přístup k Phemeu pravidelně používáte různé adresy URL, měli byste povolit nastavení "Preferovat adresu URL prohlížeče".',
      ...
      'Pheme Initializing...' => 'Inicializace systému Pheme...',
      'Pheme Setup' => 'Nastavení Pheme',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Vítejte v Phemeu. Počkejte prosím, než se nastaví některé klíčové závislosti Phemeu...',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme je nyní aktualizován na nejnovější verzi!',
      'Pheme installation complete!' => 'Instalace Pheme je dokončena!',
      ...
      'Pheme Installer' => 'Instalátor Pheme',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Vítejte na Pheme! Dokončete počáteční nastavení serveru zodpovězením několika otázek.',
      'Pheme Updater' => 'Aktualizace Pheme',
      'Change installation settings?' => 'Změnit nastavení instalace?',
      'Pheme is currently configured to listen on the following ports:' => 'Pheme je v nakonfigurován pro poslouchání na následujících portech:',
      'HTTP Port: %d' => 'HTTP port: %d',
      'HTTPS Port: %d' => 'HTTPS port: %d',
      'SFTP Port: %d' => 'SFTP port: %d',
      'Radio Ports: %s' => 'Rádiové porty: %s',
      'Customize ports used for Pheme?' => 'Přizpůsobit porty používané pro Pheme?',
      'Writing configuration files...' => 'Zapisování konfiguračních souborů...',
      'Server configuration complete!' => 'Konfigurace serveru dokončena!',
      'This file was automatically generated by Pheme.' => 'Tento soubor byl automaticky vygenerován softwarem Pheme.',
      ...
      'HTTP Port' => 'HTTP Port',
      'The main port Pheme listens to for insecure HTTP connections.' => 'Hlavní port, kterému Pheme naslouchá pro nezabezpečená připojení HTTP.',
      'HTTPS Port' => 'HTTPS Port',
      'The main port Pheme listens to for secure HTTPS connections.' => 'Hlavní port, kterému Pheme naslouchá pro zabezpečená připojení HTTPS.',
      'The port Pheme listens to for SFTP file management connections.' => 'Port, na kterém Pheme naslouchá pro připojení správy souborů SFTP.',
      'Station Ports' => 'Porty Stanic',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'Porty, na kterých má Pheme poslouchat vysílání stanic a příchozí připojení DJ.',
