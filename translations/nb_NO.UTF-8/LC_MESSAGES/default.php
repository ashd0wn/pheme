<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Alert' => 'Varsel',
      'All Days' => 'Alle Dager',
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Alle opplistede domenenavn må peke på denne Pheme installasjonen. Skill flere domenenavn med komma.',
      ...
      'Pheme First-Time Setup' => 'Pheme førstegangsoppsett',
      'Pheme Instance Name' => 'Pheme-forekomstnavn',
      'Pheme ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'Pheme leveres med en innebygd gratis IP-geolokaliseringsdatabase. Du foretrekker kanskje å bruke MaxMind GeoLite-tjenesten i stedet for å oppnå mer nøyaktige resultater. Bruk av MaxMind GeoLite krever en lisensnøkkel, men når nøkkelen er gitt, vil vi automatisk holde databasen oppdatert.',
      'Pheme Update Checks' => 'Pheme-oppdateringssjekker',
      'Pheme User' => 'Pheme-bruker',
      'Pheme uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Pheme bruker et rollebasert tilgangskontrollsystem. Roller gis tillatelser til visse deler av nettstedet, deretter blir brukere tildelt disse rollene.',
      'Pheme Wiki' => 'Pheme Wiki',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme vil skanne den opplastede filen for treff i denne stasjonens musikkbibliotek. Media skal allerede være lastet opp før du kjører dette trinnet. Du kan kjøre dette verktøyet på nytt så mange ganger du trenger.',
      'AzuraRelay is a standalone service that connects to your Pheme instance, automatically relays your stations via its own server, then reports the listener details back to your main instance. This page shows all currently connected instances.' => 'AzuraRelay er en frittstående tjeneste som kobler til Pheme-forekomsten. automatisk Sender stasjonene dine via sin egen server, så rapporter lytterdetaljene tilbake til din hovedinstans. Denne siden viser alle tilkoblede forekomster.',
      'Back' => 'Tilbake',
      ...
      'Create a new application. Choose "Scoped Access", select your preferred level of access, then name your app. Do not name it "Pheme", but rather use a name specific to your installation.' => 'Opprett et nytt program. Velg "Scoped Access", velg ditt foretrukne tilgangsnivå, og gi deretter programmet navn. Ikke gi det navnet "Pheme", men bruk snarere et navn spesifikt til installasjonen.',
      ...
      'Customize Pheme Settings' => 'Tilpass Pheme-innstillinger',
      ...
      'Donate to support Pheme!' => 'Doner for å støtte Pheme!',
      'Down' => 'Nedover',
      'Download' => 'Last ned',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Aktiver for å få Pheme til automatisk å kjøre nattlige sikkerhetskopier på det angitte tidspunktet.',
      ...
      'Enter "Pheme" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Skriv inn "Pheme" som applikasjonsnavn. Du kan la URL-feltene være uendret. For "Scopes" kreves bare "write:media" og "write:statuses".',
      ...
      'Hide Pheme Branding on Public Pages' => 'Skjul Pheme-merkevarebygging på offentlige sider',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Hvis en besøkende ikke er logget på og besøker Pheme-hjemmesiden, kan du automatisk omdirigere dem til URL-en som er spesifisert her. La stå tomt for å omdirigere dem til påloggingsskjermen som standard.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Hvis aktivert, vil Pheme automatisk ta opp alle direktesendinger til denne stasjonen til opptak per sending.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Hvis aktivert, vil Pheme koble til MusicBrainz-databasen for å forsøke å finne en ISRC for alle filer der en mangler. Deaktivering av dette kan forbedre ytelsen.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Hvis valgt, vil dette fjerne Pheme-merkevaren fra offentlige sider.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Lær mer om utgivelseskanaler i Pheme-dokumentene.',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Merk: Dette bør være den offentlige hjemmesiden til radiostasjonen, ikke Pheme-URLen. Det vil bli inkludert i kringkastingsdetaljer.',
      'Notes' => 'Merknader',
      'Notice' => 'Merknad',
      'Now' => 'Nå',
      ...
      'Powered by Pheme' => 'Drevet av Pheme',
      ...
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Oppsettinstruksjoner for kringkastingsprogramvare er tilgjengelig på Pheme-wikien.',
      'SFTP Host' => 'SMTP-Vert',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'SHOUTcast 2 DNAS er ikke gratis programvare, og dens restriktive lisens tillater ikke Pheme å distribuere SHOUTcast-binæren.',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'Vis nye utgivelser i oppdateringskanalen din på Pheme-hjemmesiden.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'Stereo Tool er ikke fri programvare, og den restriktive lisensen tillater ikke Pheme å distribuere Stereo Tool binær.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Pheme.' => 'De redigerbare tekstboksene er områder der du kan sette inn egendefinert konfigurasjonskode. De ikke-redigerbare delene genereres automatisk av Pheme.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Dette er en avansert funksjon og tilpasset kode støttes ikke offisielt av Pheme. Du kan ødelegge stasjonen din ved å legge til egendefinert kode, men å fjerne den burde løse eventuelle problemer.',
      ...
      'This mode disables Pheme\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.' => 'Denne modusen deaktiverer Phemes AutoDJ-administrasjon ved å bruke selve Liquidsoap til å administrere sangavspilling. "Neste sang" og noen andre funksjoner vil ikke være tilgjengelige.',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Dette navnet vil vises som en underoverskrift ved siden av Pheme-logoen, for å hjelpe med å identifisere denne serveren.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Denne køen inneholder de gjenværende sporene i den rekkefølgen de vil bli satt i kø av Pheme AutoDJ (hvis sporene er kvalifisert til å spilles av).',
      ...
      'Update' => 'Oppdater',
      'Update Pheme' => 'Oppdater Pheme',
      'Update Pheme via Web' => 'Oppdater Pheme via Web',
      'Update Pheme? Your installation will restart.' => 'Oppdatere Pheme? Installasjonen vil starte på nytt.',
      ...
      'Use' => 'Bruk',
      'Use (Us)' => 'Bruk (oss)',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Bruk API-nøkler for å autentisere med Pheme API ved å bruke de samme tillatelsene som brukerkontoen din.',
      ...
      'Website' => 'Nettsted',
      'Wednesday' => 'Onsdag',
      'Welcome to Pheme!' => 'Velkommen til Pheme!',
      'Welcome!' => 'Velkommen!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Du kan angi en egendefinert URL for denne strømmen som Pheme vil bruke når den refererer til den. La stå tomt for å bruke standardverdien.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Dette er en testmelding fra Pheme. Hvis du mottar denne meldingen, betyr det at e-postinnstillingene dine er riktig konfigurert.',
      'Test message sent successfully.' => 'Testmeldingen ble sendt.',
      'Pheme Application Log' => 'Pheme-applikasjonslogg',
      'Pheme Now Playing Log' => 'Pheme Spilles logg',
      'Pheme Synchronized Task Log' => 'Pheme Synkronisert oppgave-logg',
      'Pheme Queue Worker Log' => 'Pheme Kø Arbeidslogg',
      ...
      'New Pheme Stable Release Available' => 'Ny Pheme Stabil Utgivelse Tilgjengelig',
      ...
      'New Pheme Rolling Release Available' => 'Ny Pheme Rolling release tilgjengelig',
      ...
      'Pheme is free and open-source software.' => 'Pheme er fri og åpen kildekode programvare.',
      'If you are enjoying Pheme, please consider donating to support our work. We depend on donations to build new features, fix bugs, and keep Pheme modern, accessible and free.' => 'Hvis du liker Pheme, vennligst vurder å donere for å støtte arbeidet vårt. Vi er avhengige av donasjoner for å bygge nye funksjoner, fikse feil og beholde Pheme modern, tilgjengelig og gratis.',
      'Donate to Pheme' => 'Doner til Pheme',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Du kan spore utførelsestiden og minnebruken til enhver Pheme-side eller -applikasjon fra profileringssiden.',
      ...
      'This likely means that multiple Pheme instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.' => 'Dette betyr sannsynligvis at flere Pheme-forekomster kobles opp mot samme database. Denne forekomsten er ikke den aktive en, så synkroniserte oppgaver blir ikke kjørt på denne serveren. Hvis dette er intentional, kan du overse denne meldingen.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Hvis du regelmessig bruker forskjellige URL-er for å få tilgang til Pheme, bør du aktivere innstillingen "Foretrekk nettleser-URL".',
      ...
      'Pheme Initializing...' => 'Pheme initialiserer...',
      'Pheme Setup' => 'Pheme-oppsett',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Velkommen til Pheme. Vennligst vent mens noen nøkkelavhengigheter til Pheme er konfigurert...',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme er nå oppdatert til siste versjon!',
      'Pheme installation complete!' => 'Pheme-installasjonen er fullført!',
      ...
      'Pheme Installer' => 'Pheme installasjonsprogram',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Velkommen til Pheme! Fullfør det første serveroppsettet ved å svare på noen spørsmål.',
      'Pheme Updater' => 'Pheme-oppdatering',
      'Change installation settings?' => 'Vil du endre installasjonsinnstillingene?',
      'Pheme is currently configured to listen on the following ports:' => 'Pheme er for øyeblikket konfigurert til å lytte på følgende porter:',
      'HTTP Port: %d' => 'HTTP-port: %d',
      'HTTPS Port: %d' => 'Port nummer',
      'SFTP Port: %d' => 'HTTP-port: %d',
      'Radio Ports: %s' => 'Radioporter: %s',
      'Customize ports used for Pheme?' => 'Tilpasse porter som brukes for Pheme?',
      'Writing configuration files...' => 'Skriver konfigurasjonsfiler...',
      'Server configuration complete!' => 'Serverkonfigurasjon fullført!',
      'This file was automatically generated by Pheme.' => 'Denne filen ble automatisk generert av Pheme.',
      ...
      'HTTP Port' => 'HTTP-port',
      'The main port Pheme listens to for insecure HTTP connections.' => 'Hovedporten Pheme lytter til for usikre HTTP-tilkoblinger.',
      'HTTPS Port' => 'HTTPS-port',
      'The main port Pheme listens to for secure HTTPS connections.' => 'Hovedporten Pheme lytter til for sikre HTTPS-tilkoblinger.',
      'The port Pheme listens to for SFTP file management connections.' => 'Porten Pheme lytter til for SFTP-filbehandlingstilkoblinger.',
      'Station Ports' => 'Stasjonshavner',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'Portene Pheme skal lytte til for stasjonssendinger og innkommende DJ-tilkoblinger.',
