<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Pheme First-Time Setup' => 'Pheme 최초 설정',
      'Pheme Instance Name' => 'Pheme 인스턴스 이름',
      'Pheme Update Checks' => 'Pheme 업데이트 체크',
      'Pheme User' => 'Pheme 사용자',
      'Pheme Wiki' => 'Pheme 위키',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'Pheme는 이 방송국의 음악 라이브러리에서 업로드된 파일의 일치하는 내용을 검색합니다. 이 단계를 실행하기 전에 미디어를 미리 업로드해야 합니다. 필요한 횟수만큼 이 도구를 다시 실행할 수 있습니다.',
      'Back' => '뒤로',
      'Backups' => '백업',
      'Basic Info' => '기본 정보',
      ...
      'Updated' => '업데이트됨',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'API 키를 사용해 사용자 계정과 동일한 권한을 사용하여 Pheme API로 인증',
      'Username' => '사용자 이름',
      'View' => '보기',
      ...
      'Website' => '웹사이트',
      'Wednesday' => '수요일',
      'Welcome to Pheme!' => 'Pheme에 오신 것을 환영합니다!',
      'Welcome!' => '환영합니다!',
      ...
      'Pheme Application Log' => 'Pheme 응용 프로그램 로그',
      ...
      'Pheme Settings' => 'Pheme 설정',
      'Setting Key' => '설정 키',
      'Setting Value' => '설정 값',
      'Backing up MariaDB...' => 'MariaDB 백업 중...',
      'Creating backup archive...' => '백업 아카이브를 생성하는 중...',
      'Cleaning up temporary files...' => '임시 파일을 정리하는 중...',
      'Pheme Setup' => 'Pheme 설치',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Pheme에 오신 것을 환영합니다. Pheme의 일부 주요 종속성을 설정하는 동안 잠시 기다려 주십시오...',
      'Running Database Migrations' => '데이터베이스 마이그레이션 실행',
      'Refreshing All Stations' => '모든 스테이션 새로 고침',
      'Pheme is now updated to the latest version!' => 'Pheme가 최신 버전으로 업데이트되었습니다!',
      'Pheme installation complete!' => 'Pheme 설치 완료!',
