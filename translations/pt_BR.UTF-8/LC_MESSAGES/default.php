<?php return array (
  ...
  array (
    ...
    array (
      ...
      'All listed domain names should point to this Pheme installation. Separate multiple domain names with commas.' => 'Todos os nomes de domínio listados devem apontar para esta instalação do Pheme. Separe vários nomes de domínio com vírgulas.',
      ...
      'Pheme First-Time Setup' => 'Configuração do Pheme pela primeira vez',
      'Pheme Instance Name' => 'Nome da instância do Pheme',
      'Pheme ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'O Pheme vem com um banco de dados de geolocalização de IP gratuito integrado. Você pode preferir usar o serviço MaxMind GeoLite para obter resultados mais precisos. O uso do MaxMind GeoLite requer uma chave de licença, mas assim que a chave for fornecida, manteremos o banco de dados atualizado automaticamente.',
      'Pheme Update Checks' => 'Verificar Atualizações do Pheme',
      'Pheme User' => 'Pheme Usuário',
      'Pheme uses a role-based access control system. Roles are given permissions to certain sections of the site, then users are assigned into those roles.' => 'Pheme usa um sistema de controle de acesso baseado em funções. As funções recebem permissões para certas seções do site e, em seguida, os usuários são atribuídos a essas funções.',
      'Pheme Wiki' => 'Pheme Wiki',
      'Pheme will scan the uploaded file for matches in this station\'s music library. Media should already be uploaded before running this step. You can re-run this tool as many times as needed.' => 'O Pheme irá procurar no arquivo carregado por correspondências na biblioteca de músicas desta estação. A mídia já deve ser carregada antes de executar esta etapa. Você pode executar novamente essa ferramenta quantas vezes forem necessárias.',
      'AzuraRelay is a standalone service that connects to your Pheme instance, automatically relays your stations via its own server, then reports the listener details back to your main instance. This page shows all currently connected instances.' => 'AzuraRelay é um serviço autônomo que se conecta à sua instância Pheme, retransmite automaticamente suas estações por meio de seu próprio servidor e, em seguida, relata os detalhes do ouvinte de volta à sua instância principal. Esta página mostra todas as instâncias atualmente conectadas.',
      'Back' => 'Voltar',
      ...
      'Customize Pheme Settings' => 'Personalizar as Configurações do Pheme',
      ...
      'Donate to support Pheme!' => 'Doe para apoiar o Pheme!',
      'Down' => 'Para baixo',
      ...
      'Enable to have Pheme automatically run nightly backups at the time specified.' => 'Ativar para que o Pheme execute automaticamente cópias de segurança noturnas automaticamente no tempo especificado.',
      ...
      'Enter "Pheme" as the application name. You can leave the URL fields unchanged. For "Scopes", only "write:media" and "write:statuses" are required.' => 'Digite "Pheme" como o nome do aplicativo. Você pode deixar os campos de URL inalterados. Para "Scopes", apenas "write:media" e "write:statuses" são necessários.',
      ...
      'Hide Pheme Branding on Public Pages' => 'Esconder a marca Pheme em páginas públicas',
      ...
      'If a visitor is not signed in and visits the Pheme homepage, you can automatically redirect them to the URL specified here. Leave blank to redirect them to the login screen by default.' => 'Se um visitante não estiver logado e visitar a página inicial do Pheme, você pode redirecionar automaticamente para a URL especificada aqui. Deixe em branco para redirecionar para a tela de login por padrão.',
      ...
      'If enabled, Pheme will automatically record any live broadcasts made to this station to per-broadcast recordings.' => 'Se ativado, o Pheme vai gravar automaticamente quaisquer transmissões ao vivo feitas por esta estação por transmissão.',
      'If enabled, Pheme will connect to the MusicBrainz database to attempt to find an ISRC for any files where one is missing. Disabling this may improve performance.' => 'Se ativado, o Pheme irá se conectar à base de dados do MusicBrainz para tentar encontrar um ISRC para qualquer arquivo onde esteja faltando. Desativar isso pode melhorar o desempenho.',
      ...
      'If selected, this will remove the Pheme branding from public-facing pages.' => 'Se selecionado, isto irá remover a marca Pheme de páginas voltadas para o público.',
      ...
      'Learn more about release channels in the Pheme docs.' => 'Saiba mais sobre lançamento de canais na documentação do Pheme.',
      'Learn More about Replaygain' => 'Saiba mais sobre Replaygain',
      ...
      'Note: This should be the public-facing homepage of the radio station, not the Pheme URL. It will be included in broadcast details.' => 'Nota: Esta deve ser a página inicial pública da estação de rádio, não a URL do Pheme. Será incluído nos detalhes da transmissão.',
      'Notes' => 'Observações',
      'Notice' => 'Aviso',
      'Now' => 'Agora',
      ...
      'Powered by Pheme' => 'Desenvolvido por Pheme',
      ...
      'Setup instructions for broadcasting software are available on the Pheme wiki.' => 'Instruções para configurar softwares de transmissão estão disponíveis na wiki do Pheme.',
      'SFTP Host' => 'Host SFTP',
      ...
      'Shoutcast 2 DNAS is not free software, and its restrictive license does not allow Pheme to distribute the Shoutcast binary.' => 'O Shoutcast 2 DNAS não é software gratuito, e sua licença restritiva não permite que o Pheme distribua o binário do Shoutcast.',
      ...
      'Show new releases within your update channel on the Pheme homepage.' => 'Mostrar novos lançamentos em seu canal de atualização na página do Pheme.',
      ...
      'Stereo Tool is not free software, and its restrictive license does not allow Pheme to distribute the Stereo Tool binary.' => 'O Stereo Tool não é um software gratuito e sua licença restritiva não permite que o Pheme distribua o binário do Stereo Tool.',
      ...
      'The editable text boxes are areas where you can insert custom configuration code. The non-editable sections are automatically generated by Pheme.' => 'As caixas de texto editáveis são áreas onde você pode inserir um código de configuração personalizado. As seções não editáveis são geradas automaticamente pelo Pheme.',
      ...
      'This is an advanced feature and custom code is not officially supported by Pheme. You may break your station by adding custom code, but removing it should fix any issues.' => 'Este é um recurso avançado e o código personalizado não é oficialmente suportado pelo Pheme. Você pode interromper sua estação adicionando um código personalizado, mas removê-lo deve resolver todos os problemas.',
      ...
      'This mode disables Pheme\'s AutoDJ management, using Liquidsoap itself to manage song playback. "next song" and some other features will not be available.' => 'Este modo desativa o gerenciamento do AutoDJ pelo Pheme, usando o próprio Liquidsoap para gerenciar a reprodução da música. "próxima música" e alguns outros recursos não estarão disponíveis.',
      'This Month' => 'Este Mês',
      ...
      'This name will appear as a sub-header next to the Pheme logo, to help identify this server.' => 'Este nome irá aparecer como um sub cabeçalho próximo ao logo do Pheme, para ajudar a identificar este servidor.',
...
Para adicionar um novo horário agendado, clique no botão abaixo.',
      ...
      'This queue contains the remaining tracks in the order they will be queued by the Pheme AutoDJ (if the tracks are eligible to be played).' => 'Esta fila contém as faixas restantes na ordem em que serão enfileiradas pelo AutoDJ do Pheme (se as faixas puderem ser reproduzidas).',
      ...
      'Update' => 'Atualizar',
      'Update Pheme' => 'Atualizar o Pheme',
      'Update Pheme via Web' => 'Atualizar o Pheme pela Web',
      'Update Pheme? Your installation will restart.' => 'Atualizar o Pheme? Sua instalação será reiniciada.',
      ...
      'Use' => 'Uso',
      'Use (Us)' => 'Uso (Nós)',
      'Use API keys to authenticate with the Pheme API using the same permissions as your user account.' => 'Use as chaves API para autenticar com a API do Pheme utilizando as mesmas permissões que a sua conta de usuário.',
      ...
      'Weight' => 'Peso',
      'Welcome to Pheme!' => 'Bem-vindo ao Pheme!',
      'Welcome!' => 'Bem Vindo!',
      ...
      'You can set a custom URL for this stream that Pheme will use when referring to it. Leave empty to use the default value.' => 'Você pode definir uma URL personalizada para este fluxo que o Pheme usará ao se referir a ele. Deixe vazio para usar o valor padrão.',
      ...
      'This is a test message from Pheme. If you are receiving this message, it means your e-mail settings are configured correctly.' => 'Esta é uma mensagem de teste do Pheme. Se você estiver recebendo esta mensagem, significa que suas configurações de e-mail estão configuradas corretamente.',
      'Test message sent successfully.' => 'Mensagem de teste enviada com sucesso.',
      'Pheme Application Log' => 'Log do Pheme',
      'Pheme Now Playing Log' => 'Registro do Tocando Agora do Pheme',
      'Pheme Synchronized Task Log' => 'Registro das tarefas sincronizadas do Pheme',
      'Pheme Queue Worker Log' => 'Registro da fila do Worker do Pheme',
      ...
      'Set Up Pheme' => 'Configurar o Pheme',
      ...
      'New Pheme Stable Release Available' => 'Nova Versão Estável do Pheme Está Disponível',
      ...
      'New Pheme Rolling Release Available' => 'Nova Versão Rolling Realese Está Disponível',
      ...
      'Pheme is free and open-source software.' => 'O Pheme é um software livre e de código aberto.',
      'If you are enjoying Pheme, please consider donating to support our work. We depend on donations to build new features, fix bugs, and keep Pheme modern, accessible and free.' => 'Se você está gostando de Pheme, por favor considere fazer uma doação para apoiar nosso trabalho. Nós dependemos de doações para criar novas funcionalidades, corrigir bugs e manter o Pheme moderno, acessível e gratuito.',
      'Donate to Pheme' => 'Doar para o Pheme',
      ...
      'You can track the execution time and memory usage of any Pheme page or application from the profiler page.' => 'Você pode rastrear o tempo de execução e o uso de memória de qualquer página ou aplicativo Pheme na página do criador do perfil.',
      ...
      'This likely means that multiple Pheme instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.' => 'Isso provavelmente significa que várias instâncias do Pheme estão se conectando ao mesmo banco de dados. Esta instância não é a ativa atual, portanto, as tarefas sincronizadas não serão executadas neste servidor. Se isso for intencional, você pode desconsiderar esta mensagem.',
      ...
      'If you regularly use different URLs to access Pheme, you should enable the "Prefer Browser URL" setting.' => 'Se você usa regularmente URLs diferentes para acessar o Pheme, você deve habilitar a configuração "Preferir URL do Navegador".',
      ...
      'Pheme Settings' => 'Configurações Pheme',
      ...
      'Pheme Initializing...' => 'Inicializando o Pheme...',
      'Pheme Setup' => 'Pheme Setup',
      'Welcome to Pheme. Please wait while some key dependencies of Pheme are set up...' => 'Bem-vindo ao Pheme. Por favor, aguarde enquanto algumas dependências fundamentais do Pheme são configuradas...',
      ...
      'Pheme is now updated to the latest version!' => 'Pheme agora está atualizado para a versão mais recente!',
      'Pheme installation complete!' => 'Instalação Pheme completa!',
      ...
      'Pheme Installer' => 'Instalador do Pheme',
      'Welcome to Pheme! Complete the initial server setup by answering a few questions.' => 'Bem-vindo ao Pheme! Complete a configuração inicial do servidor respondendo algumas perguntas.',
      'Pheme Updater' => 'Atualizador do Pheme',
      'Change installation settings?' => 'Alterar as configurações de instalação?',
      'Pheme is currently configured to listen on the following ports:' => 'O Pheme está configurado para ser ouvido nas seguintes portas:',
      'HTTP Port: %d' => 'Porta HTTP: %d',
      'HTTPS Port: %d' => 'Porta HTTPS: %d',
      'SFTP Port: %d' => 'Porta SFTP: %d',
      'Radio Ports: %s' => 'Portas de Rádio: %s',
      'Customize ports used for Pheme?' => 'Personalizar portas usadas para o Pheme?',
      ...
      'This file was automatically generated by Pheme.' => 'Este arquivo foi gerado automaticamente pelo Pheme.',
      ...
      'The main port Pheme listens to for insecure HTTP connections.' => 'A porta principal do Pheme das conexões HTTP inseguras.',
      'HTTPS Port' => 'Porta HTTPS',
      'The main port Pheme listens to for secure HTTPS connections.' => 'A porta principal do Pheme para conexões HTTPS seguras.',
      'The port Pheme listens to for SFTP file management connections.' => 'A porta Pheme para as conexões de gerenciamento de arquivos SFTP.',
      'Station Ports' => 'Portas da Estação',
      'The ports Pheme should listen to for station broadcasts and incoming DJ connections.' => 'As portas do Pheme para transmissões de estações e conexões de entrada de DJs.',
