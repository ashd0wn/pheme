...
final class PhemeCentral
{
    use LoggerAwareTrait;
    use EnvironmentAwareTrait;
    use SettingsAwareTrait;

    private const BASE_URL = 'https://central.pheme.com';
    ...
    /**
     * Ping the Pheme Central server for updates and return them if there are any.
     *
     * @return mixed[]|null
     */
    ...
    /**
     * Ping the Pheme Central server to retrieve this installation's likely public-facing IP.
     *
     * @param bool $cached
     */
