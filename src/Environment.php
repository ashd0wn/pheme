...
final class Environment
{
    ...
    public const RELEASE_CHANNEL = 'PHEME_VERSION';

    public const SFTP_PORT = 'PHEME_SFTP_PORT';
    ...
    /**
     * @return string The parent directory the application is within, i.e. `/var/pheme`.
     */
