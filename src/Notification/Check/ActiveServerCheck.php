    ...
    public function __invoke(GetNotifications $event): void
    {
        ...
        if (!$this->highAvailability->isActiveServer()) {
            ...
            $notification->body = __(
                'This likely means that multiple Pheme instances are connecting to the same database. This instance is not the current active one, so synchronized tasks won\'t run on this server. If this is intentional, you can disregard this message.'
            );
