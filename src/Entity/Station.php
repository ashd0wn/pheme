...
class Station implements Stringable, IdentifiableEntityInterface
{
    ...
    #[
        OA\Property(example: "https://demo.pheme.com/"),
    ...
    #[
        OA\Property(example: "/var/pheme/stations/azuratest_radio"),
        ORM\Column(length: 255, nullable: true),
        Serializer\Groups([EntityGroupsInterface::GROUP_ADMIN, EntityGroupsInterface::GROUP_ALL])
    ]
    ...
    /**
     * Whether the station uses Pheme to directly manage the AutoDJ or lets the backend handle it.
     */
