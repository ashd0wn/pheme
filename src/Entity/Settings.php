...
class Settings implements Stringable
{
    ...
    #[
        OA\Property(description: "Site Base URL", example: "https://your.pheme.site"),
    ...
    #[
        OA\Property(description: "Pheme Instance Name", example: "My Pheme Instance"),
        ORM\Column(length: 255, nullable: true),
        Groups(self::GROUP_GENERAL)
    ]
    ...
    #[
        OA\Property(description: "Hide Pheme Branding on Public Pages", example: "false"),
        ORM\Column,
        Groups(self::GROUP_BRANDING)
    ]
    ...
    #[
        OA\Property(description: "The name of the sender of system e-mails.", example: "Pheme"),
        ORM\Column(length: 255, nullable: true),
        Groups(self::GROUP_GENERAL)
    ]
