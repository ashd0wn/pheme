        ...
        if (null === $config) {
            $config = [
                ...
                'PHEME_HTTP_PORT' => [
                    'name' => __('HTTP Port'),
                    'description' => __(
                        'The main port Pheme listens to for insecure HTTP connections.',
                    ),
                    'default' => 80,
                ],
                'PHEME_HTTPS_PORT' => [
                    'name' => __('HTTPS Port'),
                    'description' => __(
                        'The main port Pheme listens to for secure HTTPS connections.',
                    ),
                    'default' => 443,
                ],
                'PHEME_SFTP_PORT' => [
                    'name' => __('SFTP Port'),
                    'description' => __(
                        'The port Pheme listens to for SFTP file management connections.',
                    ),
                    'default' => 2022,
                ],
                'PHEME_STATION_PORTS' => [
                    ...
                    'description' => __(
                        'The ports Pheme should listen to for station broadcasts and incoming DJ connections.',
                    ),
