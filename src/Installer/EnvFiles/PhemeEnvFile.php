...
final class PhemeEnvFile extends AbstractEnvFile
{
    /** @inheritDoc */
            ...
            $config = [
                ...
                Environment::PROFILING_EXTENSION_ENABLED => [
                    ...
                    'description' => sprintf(
                        ...
                        'http://your-pheme-site/?SPX_KEY=dev&SPX_UI_URI=/',
                    ),
                ],
                ...
                'NGINX_CLIENT_MAX_BODY_SIZE' => [
                    ...
                    'description' => __(
                        'This is the total size any single request body can be. Pheme chunks its uploads into smaller file sizes, so this only applies when doing custom uploads via the API. Sizes should be listed in a format like "100K", "128M", "1G" for kilobytes, megabytes, and gigabytes respectively.'
                    ),
                    'default' => '50M',
                ],
    ...
    {
        return $baseDir . DIRECTORY_SEPARATOR . 'pheme.env';
    }
}
