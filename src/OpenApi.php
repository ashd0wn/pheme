...
#[
    OA\OpenApi(
        ...
        info: new OA\Info(
            ...
            description: "Pheme is a standalone, turnkey web radio management tool. Radio stations hosted by"
            . " Pheme expose a public API for viewing now playing data, making requests and more.",
            title: 'Pheme',
        ...
        externalDocs: new OA\ExternalDocumentation(
            description: "Pheme on GitHub",
            url: "https://github.com/Pheme/Pheme"
        )
    ),
    OA\Parameter(
