<template>
    <card-page :title="$gettext('Connected AzuraRelays')">
        <template #info>
            <p class="card-text">
                {{
                    $gettext('AzuraRelay is a standalone service that connects to your Pheme instance, automatically relays your stations via its own server, then reports the listener details back to your main instance. This page shows all currently connected instances.')
                }}
            </p>
            ...
            <a
                ...
                target="_blank"
                href="https://github.com/Pheme/AzuraRelay"
            >
