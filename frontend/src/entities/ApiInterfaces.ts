...
export interface ApiAdminRelay {
  ...
  /**
   * Station description
   * @example "An Pheme station!"
   */
  description?: string | null;
  /**
   * Station homepage URL
   * @example "https://www.pheme.com/"
   */
  url?: string | null;
  /**
...
export type ApiAdminStorageLocation = HasLinks & {
   ...
   * @example "/var/pheme/stations/azuratest_radio/media"
   */
  path?: string | null;
  /**
...
export interface Settings {
  ...
  /**
   * Site Base URL
   * @example "https://your.pheme.site"
   */
  base_url?: string | null;
  /**
   * Pheme Instance Name
   * @example "My Pheme Instance"
   */
  ...
  /**
   * Hide Pheme Branding on Public Pages
   * @example "false"
   */
...
export type Station = HasAutoIncrementId & {
  ...
  description?: string | null;
  /** @example "https://demo.pheme.com/" */
  url?: string | null;
  /** @example "Various" */
  genre?: string | null;
  /** @example "/var/pheme/stations/azuratest_radio" */
