...
This file will include the majority of the known issues we're aware of with Pheme and that are in the stages of
...
metadata when the client connects. This is often reported as Pheme "missing" the first song that a DJ broadcasts.
...
unknown. [#5116](https://github.com/Pheme/Pheme/issues/5116)
...
play when _no_ scheduled playlist is available to play. This is the intended functionality of Pheme, but some users
